// Vercel serverless function for participation points API
...
const storage = {
  ...
  addParticipationPoint: async (studentId: string, classId: string, week: string): Promise<Participation> => {
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    console.error('Error in classroom/participation/point:', error);
