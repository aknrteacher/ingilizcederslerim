...
interface PreschoolGameHeaderProps {
  gameName: string;
  description: string;
  containerId: string;
  icon?: ReactNode;
...
export function PreschoolGameHeader({ gameName, description, containerId, icon }: PreschoolGameHeaderProps) {
  ...
  return (
    <div className="preschool-game-header">
