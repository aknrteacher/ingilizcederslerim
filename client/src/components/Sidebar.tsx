...
import logo from "@assets/generated_images/minimalist_english_education_logo.png"
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r bg-sidebar text-sidebar-foreground">
      <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-4">
        <img src={logo} alt="LinguaLearn Logo" className="h-8 w-8 rounded-md object-cover" />
        <span className="font-serif text-lg font-bold tracking-tight">LinguaLearn</span>
      </div>
