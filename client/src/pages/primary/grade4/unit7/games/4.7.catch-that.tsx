...
import "@/styles/4.6.catch-that.css";
import "@/styles/primary-school-game-header.css";
import "@/styles/primary-school-game-footer.css";

// Unit 7 vocabulary - uppercase for catch-that (Jobs)
const vocabulary = [
  { word: "JOB", turkish: "iş, meslek", file: "job.png" },
  { word: "TEACHER", turkish: "öğretmen", file: "teacher.png" },
  { word: "DOCTOR", turkish: "doktor", file: "doctor.png" },
  { word: "NURSE", turkish: "hemşire", file: "nurse.png" },
  { word: "WRITER", turkish: "yazar", file: "writer.png" },
  { word: "VET", turkish: "veteriner", file: "vet.png" },
  { word: "FIREFIGHTER", turkish: "itfaiyeci", file: "firefighter.png" },
  { word: "WAITER", turkish: "garson", file: "waiter.png" },
  { word: "FARMER", turkish: "çiftçi", file: "farmer.png" },
  { word: "ACTOR, ACTRESS", turkish: "erkek oyuncu, kadın oyuncu", file: "actor, actress.png" },
  { word: "PILOT", turkish: "pilot", file: "pilot.png" },
  { word: "DANCER", turkish: "dansçı", file: "dancer.png" },
  { word: "SINGER", turkish: "şarkıcı", file: "singer.png" },
  { word: "BUSINESSMAN", turkish: "iş adamı", file: "businessman.png" },
  { word: "MUSICIAN", turkish: "müzisyen", file: "musician.png" },
  { word: "CHEF", turkish: "şef", file: "chef.png" },
  { word: "DENTIST", turkish: "diş hekimi", file: "dentist.png" },
  { word: "POLICE OFFICER", turkish: "polis", file: "police officer.png" },
  { word: "STUDENT", turkish: "öğrenci", file: "student.png" },
  { word: "FIRE STATION", turkish: "itfaiye", file: "fire station.png" },
  { word: "HOSPITAL", turkish: "hastane", file: "hospital.png" },
  { word: "RESTAURANT", turkish: "restoran", file: "restaurant.png" },
  { word: "FARM", turkish: "çiftlik", file: "farm.png" },
  { word: "POLICE STATION", turkish: "polis karakolu", file: "police station.png" },
  { word: "AIRPORT", turkish: "havaalanı", file: "airport.png" },
  { word: "WORK", turkish: "çalışmak", file: "work.png" },
  { word: "LIKE", turkish: "sevmek", file: "like.png" },
  { word: "PLANE", turkish: "uçak", file: "plane.png" },
  { word: "HELP", turkish: "yardım etmek", file: "help.png" },
  { word: "COOK", turkish: "yemek yapmak", file: "cook.png" },
  { word: "WRITE", turkish: "yazmak", file: "write.png" },
  { word: "WHERE", turkish: "nerede", file: "where.png" },
  { word: "TEACH", turkish: "öğretmek", file: "teach.png" },
  { word: "BECAUSE", turkish: "çünkü", file: "because.png" },
];
...
export default function CatchThatGame4_7() {
