...
export default function MatchingGame4_8() {
  const [, setLocation] = useLocation();
  const allVocabulary = [
    { word: "seasons", file: "seasons.png", turkish: "mevsimler" },
    ...
    { word: "clothes", file: "clothes.png", turkish: "kıyafetler" },
    { word: "dress", file: "dress.png", turkish: "elbise" },
    { word: "shirt", file: "shirt.png", turkish: "gömlek" },
    { word: "trousers", file: "trousers.png", turkish: "pantolon" },
    { word: "jacket", file: "jacket.png", turkish: "ceket" },
    { word: "shorts", file: "shorts.png", turkish: "şort" },
    { word: "sweater, jumper", file: "sweater, jumper.png", turkish: "kazak" },
    { word: "skirt", file: "skirt.png", turkish: "etek" },
    { word: "socks", file: "socks.png", turkish: "çorap" },
    { word: "hat", file: "hat.png", turkish: "şapka" },
    { word: "gloves", file: "gloves.png", turkish: "eldiven" },
    { word: "shoes", file: "shoes.png", turkish: "ayakkabı" },
    { word: "trainers", file: "trainers.png", turkish: "spor ayakkabı" },
    { word: "boots", file: "boots.png", turkish: "bot" },
    { word: "coat", file: "coat.png", turkish: "mont" },
    { word: "umbrella", file: "umbrella.png", turkish: "şemsiye" },
    { word: "scarf", file: "scarf.png", turkish: "atkı" },
    { word: "sunglasses", file: "sunglasses.png", turkish: "güneş gözlüğü" },
    { word: "today", file: "today.png", turkish: "bugün" },
    { word: "wear", file: "wear.png", turkish: "giymek" },
  ];
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/primary/4.8/${item.file}`,
  ...
  const shareGame = () => {
    const text = `I just scored ${formatTime(elapsedTime)} on Matchlings Unit 8! Can you beat my time? 🎮`;
    if (navigator.share) {
      navigator.share({
        title: "Matchlings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Matchlings Unit 8! Can you match all the words faster than my ${formatTime(elapsedTime)}? 🏆`;
    if (navigator.share) {
      navigator.share({
                  ...
                  <div className="win-modal">
                    <div className="win-content">
                      ...
                      <div className="win-buttons">
                        ...
                        <Button variant="ghost" onClick={() => setLocation("/primary-school/grade-4/unit-8/games")} className="btn-secondary">
                          Back to Games
                        </Button>
                      </div>
                    </div>
