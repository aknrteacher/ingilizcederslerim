...
const allVocabulary = [
  ...
  { word: "sweater", file: "sweater, jumper.png", turkish: "kazak" },
  { word: "jumper", file: "sweater, jumper.png", turkish: "kazak" },
...
export default function WordSnakeGame4_8() {
          ...
          {gameStarted && !gameOver && (
            <>
              ...
              <div 
                className="game-grid"
                style={{
                  backgroundImage: targetWord ? `url(/images/primary/4.8/${targetWord.file})` : 'none'
                }}
              >
                {/* Snake */}
