...
// Vocabulary from 4.8 (Unit 8: My Clothes)
const vocabulary = [
  { word: "SEASONS", clue: "mevsimler", file: "seasons.png" },
  { word: "SPRING", clue: "ilkbahar", file: "spring.png" },
  { word: "SUMMER", clue: "yaz", file: "summer.png" },
  { word: "AUTUMN", clue: "sonbahar", file: "autumn.png" },
  { word: "WINTER", clue: "kış", file: "winter.png" },
  { word: "WEATHER", clue: "hava durumu", file: "weather.png" },
  { word: "SUNNY", clue: "güneşli", file: "sunny.png" },
  { word: "RAINY", clue: "yağmurlu", file: "rainy.png" },
  { word: "SNOWY", clue: "karlı", file: "snowy.png" },
  { word: "CLOUDY", clue: "bulutlu", file: "cloudy.png" },
  { word: "WINDY", clue: "rüzgarlı", file: "windy.png" },
  { word: "HOT", clue: "sıcak", file: "hot.png" },
  { word: "COLD", clue: "soğuk", file: "cold.png" },
  { word: "WARM", clue: "ılık", file: "warm.png" },
  { word: "CLOTHES", clue: "kıyafetler", file: "clothes.png" },
  { word: "DRESS", clue: "elbise", file: "dress.png" },
  { word: "SHIRT", clue: "gömlek", file: "shirt.png" },
  { word: "TROUSERS", clue: "pantolon", file: "trousers.png" },
  { word: "JACKET", clue: "ceket", file: "jacket.png" },
  { word: "SHORTS", clue: "şort", file: "shorts.png" },
  { word: "SWEATER", clue: "kazak", file: "sweater, jumper.png" },
  { word: "JUMPER", clue: "kazak", file: "sweater, jumper.png" },
  { word: "SKIRT", clue: "etek", file: "skirt.png" },
  { word: "SOCKS", clue: "çorap", file: "socks.png" },
  { word: "HAT", clue: "şapka", file: "hat.png" },
  { word: "GLOVES", clue: "eldiven", file: "gloves.png" },
  { word: "SHOES", clue: "ayakkabı", file: "shoes.png" },
  { word: "TRAINERS", clue: "spor ayakkabı", file: "trainers.png" },
  { word: "BOOTS", clue: "bot", file: "boots.png" },
  { word: "COAT", clue: "mont", file: "coat.png" },
  { word: "UMBRELLA", clue: "şemsiye", file: "umbrella.png" },
  { word: "SCARF", clue: "atkı", file: "scarf.png" },
  { word: "SUNGLASSES", clue: "güneş gözlüğü", file: "sunglasses.png" },
  { word: "TODAY", clue: "bugün", file: "today.png" },
  { word: "WEAR", clue: "giymek", file: "wear.png" },
];
...
export default function CrosswordGame4_8() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/4.8/${vocab.file}` : null;
  ...
  const shareGame = () => {
    const text = `I just solved the Unit 8 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 8",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 8 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
        ...
        <div className="crossword-game-container">
          <>
            ...
            <PrimarySchoolGameHeader 
              gameName="Word Cross"
              description="Grade 4 - Unit 8: My Clothes"
            ...
            <div className="primary-school-game-footer relative z-10">
              <div className="footer-content">
                ...
                <div className="footer-right">
                  ...
                  <Button variant="outline" className="footer-button" onClick={() => setLocation("/primary-school/grade-4/unit-8/games")}>
                    ← Back
                  </Button>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-4/unit-8/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
