...
// Unit 8 vocabulary - uppercase for catch-that (My Clothes)
const vocabulary = [
  { word: "SEASONS", turkish: "mevsimler", file: "seasons.png" },
  { word: "SPRING", turkish: "ilkbahar", file: "spring.png" },
  { word: "SUMMER", turkish: "yaz", file: "summer.png" },
  { word: "AUTUMN", turkish: "sonbahar", file: "autumn.png" },
  { word: "WINTER", turkish: "kış", file: "winter.png" },
  { word: "WEATHER", turkish: "hava durumu", file: "weather.png" },
  ...
  { word: "CLOUDY", turkish: "bulutlu", file: "cloudy.png" },
  { word: "WINDY", turkish: "rüzgarlı", file: "windy.png" },
  { word: "HOT", turkish: "sıcak", file: "hot.png" },
  { word: "COLD", turkish: "soğuk", file: "cold.png" },
  { word: "WARM", turkish: "ılık", file: "warm.png" },
  { word: "CLOTHES", turkish: "kıyafetler", file: "clothes.png" },
  { word: "DRESS", turkish: "elbise", file: "dress.png" },
  { word: "SHIRT", turkish: "gömlek", file: "shirt.png" },
  { word: "TROUSERS", turkish: "pantolon", file: "trousers.png" },
  { word: "JACKET", turkish: "ceket", file: "jacket.png" },
  { word: "SHORTS", turkish: "şort", file: "shorts.png" },
  { word: "SWEATER, JUMPER", turkish: "kazak", file: "sweater, jumper.png" },
  { word: "SKIRT", turkish: "etek", file: "skirt.png" },
  { word: "SOCKS", turkish: "çorap", file: "socks.png" },
  { word: "HAT", turkish: "şapka", file: "hat.png" },
  { word: "GLOVES", turkish: "eldiven", file: "gloves.png" },
  { word: "SHOES", turkish: "ayakkabı", file: "shoes.png" },
  { word: "TRAINERS", turkish: "spor ayakkabı", file: "trainers.png" },
  { word: "BOOTS", turkish: "bot", file: "boots.png" },
  { word: "COAT", turkish: "mont", file: "coat.png" },
  { word: "UMBRELLA", turkish: "şemsiye", file: "umbrella.png" },
  { word: "SCARF", turkish: "atkı", file: "scarf.png" },
  { word: "SUNGLASSES", turkish: "güneş gözlüğü", file: "sunglasses.png" },
  { word: "TODAY", turkish: "bugün", file: "today.png" },
  { word: "WEAR", turkish: "giymek", file: "wear.png" },
];
...
export default function CatchThatGame4_8() {
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={`/images/primary/4.8/${encodeURIComponent(currentWord.file)}`}
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-4/unit-8/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
