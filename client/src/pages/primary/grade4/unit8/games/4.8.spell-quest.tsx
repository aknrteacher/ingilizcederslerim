...
export default function SpellQuestGame4_8() {
          ...
          {!gameComplete && currentWord && (
            <div className="game-main">
              ...
              <div className="picture-area">
                ...
                >
                  <img 
                    src={`/images/primary/4.8/${currentWord.file}`} 
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <Button variant="outline" onClick={() => setLocation("/primary-school/grade-4/unit-8/games")}>
                  Back to Games
                </Button>
                </div>
              </div>
