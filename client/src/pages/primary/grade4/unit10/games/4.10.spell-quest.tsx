...
export default function SpellQuestGame4_10() {
          ...
          {!gameComplete && currentWord && (
            <div className="game-main">
              ...
              <div className="picture-area">
                ...
                >
                  <img 
                    src={`/images/primary/4.10/${currentWord.file}`} 
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <Button variant="outline" onClick={() => setLocation("/primary-school/grade-4/unit-10/games")}>
                  Back to Games
                </Button>
                </div>
              </div>
