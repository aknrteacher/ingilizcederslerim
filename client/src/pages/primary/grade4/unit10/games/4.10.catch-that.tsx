...
// Unit 10 vocabulary - uppercase for catch-that (Food and Drinks)
const vocabulary = [
  { word: "FOOD", turkish: "yiyecek", file: "food.png" },
  { word: "BREAD", turkish: "ekmek", file: "bread.png" },
  { word: "BUTTER", turkish: "tereyağı", file: "butter.png" },
  { word: "CHEESE", turkish: "peynir", file: "cheese.png" },
  { word: "CAKE", turkish: "pasta", file: "cake.png" },
  { word: "HONEY", turkish: "bal", file: "honey.png" },
  { word: "MEAT", turkish: "et", file: "meat.png" },
  { word: "OLIVES", turkish: "zeytin", file: "olives.png" },
  { word: "PASTA", turkish: "makarna", file: "pasta.png" },
  { word: "SOUP", turkish: "çorba", file: "soup.png" },
  { word: "CHICKEN", turkish: "tavuk", file: "chicken.png" },
  { word: "FISH", turkish: "balık", file: "fish.png" },
  { word: "CHIPS", turkish: "patates kızartması", file: "chips.png" },
  { word: "EGG", turkish: "yumurta", file: "egg.png" },
  { word: "SALAD", turkish: "salata", file: "salad.png" },
  { word: "YOGHURT", turkish: "yoğurt", file: "yoghurt.png" },
  { word: "DRINK", turkish: "içecek", file: "drink.png" },
  { word: "WATER", turkish: "su", file: "water.png" },
  { word: "TEA", turkish: "çay", file: "tea.png" },
  { word: "LEMONADE", turkish: "limonata", file: "lemonade.png" },
  { word: "JUICE", turkish: "meyve suyu", file: "juice.png" },
  { word: "FRUIT", turkish: "meyve", file: "fruit.png" },
  { word: "BANANA", turkish: "muz", file: "banana.png" },
  { word: "PEAR", turkish: "armut", file: "pear.png" },
  { word: "GRAPES", turkish: "üzüm", file: "grapes.png" },
  { word: "WATERMELON", turkish: "karpuz", file: "watermelon.png" },
  { word: "APRICOT", turkish: "kayısı", file: "apricot.png" },
  { word: "CHERRY", turkish: "kiraz", file: "cherry.png" },
  { word: "BREAKFAST", turkish: "kahvaltı", file: "breakfast.png" },
  { word: "LUNCH", turkish: "öğle yemeği", file: "lunch.png" },
  { word: "DINNER", turkish: "akşam yemeği", file: "dinner.png" },
  { word: "HUNGRY", turkish: "aç", file: "hungry.png" },
  { word: "THIRSTY", turkish: "susamış", file: "thirsty.png" },
  { word: "WANT", turkish: "istemek", file: "want.png" },
  { word: "DELICIOUS", turkish: "lezzetli", file: "delicious.png" },
];
...
export default function CatchThatGame4_10() {
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={`/images/primary/4.10/${encodeURIComponent(currentWord.file)}`}
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-4/unit-10/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
