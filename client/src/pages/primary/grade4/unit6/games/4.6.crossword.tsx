...
const vocabulary = [
  { word: "FUN", clue: "eğlence", file: "fun.png" },
  { word: "SCIENCE", clue: "bilim", file: "science.png" },
  { word: "COLOUR", clue: "renk", file: "colour.png" },
  { word: "RAINBOW", clue: "gökkuşağı", file: "rainbow.png" },
  { word: "TAIL", clue: "kuyruk", file: "tail.png" },
  { word: "BOWL", clue: "kase", file: "bowl.png" },
  { word: "MILK", clue: "süt", file: "milk.png" },
  { word: "DISH", clue: "tabak", file: "dish.png" },
  { word: "SOAP", clue: "sabun", file: "soap.png" },
  { word: "COTTON", clue: "pamuk", file: "cotton.png" },
  { word: "FOOD", clue: "yiyecek", file: "food.png" },
  { word: "PRIMARY", clue: "birincil", file: "primary.png" },
  { word: "SECONDARY", clue: "ikincil", file: "secondary.png" },
  { word: "MIX", clue: "karıştırmak", file: "mix.png" },
  { word: "GET", clue: "almak", file: "get.png" },
  { word: "PAINT", clue: "boya", file: "paint.png" },
  { word: "BRUSH", clue: "fırça", file: "brush.png" },
  { word: "BOX", clue: "kutu", file: "box.png" },
  { word: "SALT", clue: "tuz", file: "salt.png" },
  { word: "SAUCEPAN", clue: "tencere", file: "saucepan.png" },
  { word: "CLOCK", clue: "saat", file: "clock.png" },
  { word: "TABLE", clue: "masa", file: "table.png" },
  { word: "CUP", clue: "fincan", file: "cup.png" },
  { word: "BOARD", clue: "tahta", file: "board.png" },
  { word: "SCALE", clue: "terazi", file: "scale.png" },
  { word: "BED", clue: "yatak", file: "bed.png" },
  { word: "PAPER", clue: "kağıt", file: "paper.png" },
  { word: "LOOK", clue: "bakmak", file: "look.png" },
  { word: "STONE", clue: "taş", file: "stone.png" },
  { word: "CHARCOAL", clue: "kömür", file: "charcoal.png" },
  { word: "JAR", clue: "kavanoz", file: "jar.png" },
  { word: "SOIL", clue: "toprak", file: "soil.png" },
  { word: "PLANT", clue: "bitki", file: "plant.png" },
  { word: "LID", clue: "kapak", file: "lid.png" },
  { word: "CANDLE", clue: "mum", file: "candle.png" },
  { word: "LIQUID", clue: "sıvı", file: "liquid.png" },
  { word: "HEAT", clue: "ısı", file: "heat.png" },
  { word: "GLASS", clue: "cam", file: "glass.png" },
  { word: "SHAKE", clue: "sallamak", file: "shake.png" },
  { word: "FLOWER", clue: "çiçek", file: "flower.png" },
  { word: "RESULT", clue: "sonuç", file: "result.png" },
];
...
export default function CrosswordGame4_6() {
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 6 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-4/unit-6/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
