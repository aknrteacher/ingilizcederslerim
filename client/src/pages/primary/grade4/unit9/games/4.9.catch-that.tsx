...
// Unit 9 vocabulary - uppercase for catch-that (My Friends)
const vocabulary = [
  { word: "HAIR", turkish: "saç", file: "hair.png" },
  { word: "STRAIGHT", turkish: "düz", file: "straight.png" },
  { word: "CURLY", turkish: "kıvırcık", file: "curly.png" },
  { word: "WAVY", turkish: "dalgalı", file: "wavy.png" },
  ...
  { word: "BLONDE", turkish: "sarışın", file: "blonde.png" },
  { word: "DARK", turkish: "esmer", file: "dark.png" },
  { word: "BEARD", turkish: "sakal", file: "beard.png" },
  { word: "MOUSTACHE", turkish: "bıyık", file: "moustache.png" },
  { word: "GLASSES", turkish: "gözlük", file: "glasses.png" },
  { word: "BALD", turkish: "kel", file: "bald.png" },
  { word: "TALL", turkish: "uzun boylu", file: "tall.png" },
  { word: "LONG", turkish: "uzun", file: "long.png" },
  { word: "SHORT", turkish: "kısa", file: "short.png" },
  { word: "MEDIUMHEIGHT", turkish: "orta boy", file: "medium height.png" },
  { word: "BEAUTIFUL", turkish: "güzel", file: "beautiful.png" },
  { word: "HANDSOME", turkish: "yakışıklı", file: "handsome.png" },
  { word: "KIND", turkish: "nazik", file: "kind.png" },
  { word: "BIG", turkish: "büyük", file: "big.png" },
  { word: "SMALL", turkish: "küçük", file: "small.png" },
  { word: "SLIM", turkish: "ince", file: "slim.png" },
  { word: "FAT", turkish: "şişman", file: "fat.png" },
  { word: "YOUNG", turkish: "genç", file: "young.png" },
  { word: "OLD", turkish: "yaşlı", file: "old.png" },
  { word: "CELEBRITY", turkish: "ünlü", file: "celebrity.png" },
  { word: "LOOKLIKE", turkish: "-e benzemek", file: "look like.png" },
  { word: "HAVEGOT", turkish: "sahip olmak", file: "have got.png" },
  { word: "HASGOT", turkish: "sahip olmak (o)", file: "has got.png" },
];
...
export default function CatchThatGame4_9() {
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={`/images/primary/4.9/${encodeURIComponent(currentWord.file)}`}
