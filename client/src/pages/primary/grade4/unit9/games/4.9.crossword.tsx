...
// Vocabulary from 4.9 (Unit 9: My Friends)
const vocabulary = [
  { word: "HAIR", clue: "saç", file: "hair.png" },
  { word: "STRAIGHT", clue: "düz", file: "straight.png" },
  { word: "CURLY", clue: "kıvırcık", file: "curly.png" },
  { word: "WAVY", clue: "dalgalı", file: "wavy.png" },
  ...
  { word: "BLONDE", clue: "sarışın", file: "blonde.png" },
  { word: "DARK", clue: "esmer", file: "dark.png" },
  { word: "BEARD", clue: "sakal", file: "beard.png" },
  { word: "MOUSTACHE", clue: "bıyık", file: "moustache.png" },
  { word: "GLASSES", clue: "gözlük", file: "glasses.png" },
  { word: "BALD", clue: "kel", file: "bald.png" },
  { word: "TALL", clue: "uzun boylu", file: "tall.png" },
  { word: "LONG", clue: "uzun", file: "long.png" },
  { word: "SHORT", clue: "kısa", file: "short.png" },
  { word: "MEDIUMHEIGHT", clue: "orta boy", file: "medium height.png" },
  { word: "BEAUTIFUL", clue: "güzel", file: "beautiful.png" },
  { word: "HANDSOME", clue: "yakışıklı", file: "handsome.png" },
  { word: "KIND", clue: "nazik", file: "kind.png" },
  { word: "BIG", clue: "büyük", file: "big.png" },
  { word: "SMALL", clue: "küçük", file: "small.png" },
  { word: "SLIM", clue: "ince", file: "slim.png" },
  { word: "FAT", clue: "şişman", file: "fat.png" },
  { word: "YOUNG", clue: "genç", file: "young.png" },
  { word: "OLD", clue: "yaşlı", file: "old.png" },
  { word: "CELEBRITY", clue: "ünlü", file: "celebrity.png" },
  { word: "LOOKLIKE", clue: "-e benzemek", file: "look like.png" },
  { word: "HAVEGOT", clue: "sahip olmak", file: "have got.png" },
  { word: "HASGOT", clue: "sahip olmak (o)", file: "has got.png" },
];
...
export default function CrosswordGame4_9() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/4.9/${vocab.file}` : null;
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 9 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
        ...
        <div className="crossword-game-container">
          <>
            ...
            <PrimarySchoolGameHeader 
              gameName="Word Cross"
              description="Grade 4 - Unit 9: My Friends"
            ...
            <div className="primary-school-game-footer relative z-10">
              <div className="footer-content">
                ...
                <div className="footer-right">
                  ...
                  <Button variant="outline" className="footer-button" onClick={() => setLocation("/primary-school/grade-4/unit-9/games")}>
                    ← Back
                  </Button>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-4/unit-9/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
