...
export default function MatchingGame4_9() {
  const [, setLocation] = useLocation();
  const allVocabulary = [
    { word: "hair", file: "hair.png", turkish: "saç" },
    { word: "straight", file: "straight.png", turkish: "düz" },
    { word: "curly", file: "curly.png", turkish: "kıvırcık" },
    { word: "wavy", file: "wavy.png", turkish: "dalgalı" },
    ...
    { word: "blonde", file: "blonde.png", turkish: "sarışın" },
    { word: "dark", file: "dark.png", turkish: "esmer" },
    { word: "beard", file: "beard.png", turkish: "sakal" },
    { word: "moustache", file: "moustache.png", turkish: "bıyık" },
    { word: "glasses", file: "glasses.png", turkish: "gözlük" },
    { word: "bald", file: "bald.png", turkish: "kel" },
    { word: "tall", file: "tall.png", turkish: "uzun boylu" },
    { word: "long", file: "long.png", turkish: "uzun" },
    { word: "short", file: "short.png", turkish: "kısa" },
    { word: "medium height", file: "medium height.png", turkish: "orta boy" },
    { word: "beautiful", file: "beautiful.png", turkish: "güzel" },
    { word: "handsome", file: "handsome.png", turkish: "yakışıklı" },
    { word: "kind", file: "kind.png", turkish: "nazik" },
    { word: "big", file: "big.png", turkish: "büyük" },
    { word: "small", file: "small.png", turkish: "küçük" },
    { word: "slim", file: "slim.png", turkish: "ince" },
    { word: "fat", file: "fat.png", turkish: "şişman" },
    { word: "young", file: "young.png", turkish: "genç" },
    { word: "old", file: "old.png", turkish: "yaşlı" },
    { word: "celebrity", file: "celebrity.png", turkish: "ünlü" },
    { word: "look like", file: "look like.png", turkish: "-e benzemek" },
    { word: "have got", file: "have got.png", turkish: "sahip olmak" },
    { word: "has got", file: "has got.png", turkish: "sahip olmak (o)" },
  ];
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/primary/4.9/${item.file}`,
  ...
  const shareGame = () => {
    const text = `I just scored ${formatTime(elapsedTime)} on Matchlings Unit 9! Can you beat my time? 🎮`;
    if (navigator.share) {
      navigator.share({
        title: "Matchlings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Matchlings Unit 9! Can you match all the words faster than my ${formatTime(elapsedTime)}? 🏆`;
    if (navigator.share) {
      navigator.share({
                  ...
                  <div className="win-modal">
                    <div className="win-content">
                      ...
                      <div className="win-buttons">
                        ...
                        <Button variant="ghost" onClick={() => setLocation("/primary-school/grade-4/unit-9/games")} className="btn-secondary">
                          Back to Games
                        </Button>
                      </div>
                    </div>
                ...
                <div className="footer-content">
                  ...
                  <div className="footer-right">
                    ...
                    <Button
                      variant="outline"
                      className="footer-button"
                      onClick={() => setLocation("/primary-school/grade-4/unit-9/games")}
                    >
                      ← Back
                    </Button>
                  </div>
