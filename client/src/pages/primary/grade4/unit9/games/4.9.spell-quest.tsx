...
export default function SpellQuestGame4_9() {
          ...
          {!gameComplete && currentWord && (
            <div className="game-main">
              ...
              <div className="picture-area">
                ...
                >
                  <img 
                    src={`/images/primary/4.9/${currentWord.file}`} 
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <Button variant="outline" onClick={() => setLocation("/primary-school/grade-4/unit-9/games")}>
                  Back to Games
                </Button>
                </div>
              </div>
