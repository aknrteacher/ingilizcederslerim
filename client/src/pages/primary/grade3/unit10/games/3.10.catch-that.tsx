...
// Unit 10 vocabulary - uppercase keys for catch-that
const vocabulary = [
  { word: "ANIMAL", turkish: "Hayvan", file: "animal.png" },
  { word: "BEAR", turkish: "Ayı", file: "bear.png" },
  { word: "WHALE", turkish: "Balina", file: "whale.png" },
  { word: "BEE", turkish: "Arı", file: "bee.png" },
  { word: "DOLPHIN", turkish: "Yunus", file: "dolphin.png" },
  { word: "FROG", turkish: "Kurbağa", file: "frog.png" },
  { word: "BIRD", turkish: "Kuş", file: "bird.png" },
  { word: "FISH", turkish: "Balık", file: "fish.png" },
  { word: "SHARK", turkish: "Köpekbalığı", file: "shark.png" },
  { word: "INSECT", turkish: "Böcek", file: "insect.png" },
  { word: "PIGEON", turkish: "Güvercin", file: "pigeon.png" },
  { word: "LADYBUG", turkish: "Uğur böceği", file: "ladybug.png" },
  { word: "WILD", turkish: "Vahşi", file: "wild.png" },
  { word: "MOUNTAIN", turkish: "Dağ", file: "mountain.png" },
  { word: "FOREST", turkish: "Orman", file: "forest.png" },
  { word: "SEA", turkish: "Deniz", file: "sea.png" },
  ...
  { word: "DISLIKE", turkish: "Sevmemek", file: "dislike.png" },
  { word: "LIVE", turkish: "Yaşamak", file: "live.png" },
  { word: "IT", turkish: "O", file: "it.png" },
  { word: "THEY", turkish: "Onlar", file: "they.png" },
];
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={'/images/primary/3.10/' + currentWord.file} 
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-3/unit-10/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
