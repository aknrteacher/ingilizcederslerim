...
// Vocabulary from 3.10 (Unit 10: Nature)
const vocabulary = [
  { word: "ANIMAL", clue: "Hayvan", file: "animal.png" },
  { word: "BEAR", clue: "Ayı", file: "bear.png" },
  { word: "WHALE", clue: "Balina", file: "whale.png" },
  { word: "BEE", clue: "Arı", file: "bee.png" },
  { word: "DOLPHIN", clue: "Yunus", file: "dolphin.png" },
  { word: "FROG", clue: "Kurbağa", file: "frog.png" },
  { word: "BIRD", clue: "Kuş", file: "bird.png" },
  { word: "FISH", clue: "Balık", file: "fish.png" },
  { word: "SHARK", clue: "Köpekbalığı", file: "shark.png" },
  { word: "INSECT", clue: "Böcek", file: "insect.png" },
  { word: "PIGEON", clue: "Güvercin", file: "pigeon.png" },
  { word: "LADYBUG", clue: "Uğur böceği", file: "ladybug.png" },
  { word: "WILD", clue: "Vahşi", file: "wild.png" },
  { word: "MOUNTAIN", clue: "Dağ", file: "mountain.png" },
  { word: "FOREST", clue: "Orman", file: "forest.png" },
  ...
  { word: "DISLIKE", clue: "Sevmemek", file: "dislike.png" },
  { word: "LIVE", clue: "Yaşamak", file: "live.png" },
  { word: "IT", clue: "O", file: "it.png" },
  { word: "THEY", clue: "Onlar", file: "they.png" },
];
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.10/${vocab.file}` : null;
  ...
  const shareGame = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 10: Nature",
        text: text,
        ...
        <div className="crossword-game-container">
          <>
            ...
            <PrimarySchoolGameHeader 
              gameName="Word Cross"
              description="Grade 3 - Unit 10: Nature"
            ...
            <div className="primary-school-game-footer relative z-10">
              <div className="footer-content">
                ...
                <div className="footer-right">
                  ...
                  <Button variant="outline" className="footer-button" onClick={() => setLocation("/primary-school/grade-3/unit-10/games")}>
                    ← Back
                  </Button>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-10/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
