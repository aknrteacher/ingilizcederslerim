...
// Vocabulary from 3.7 (Unit 7: In My City)
const vocabulary = [
  { word: "BUILDING", clue: "Bina", file: "building.png" },
  { word: "PLACE", clue: "Yer", file: "place.png" },
  { word: "SCHOOL", clue: "Okul", file: "school.png" },
  { word: "LIBRARY", clue: "Kütüphane", file: "library.png" },
  { word: "SHOPPINGCENTRE", clue: "Alışveriş merkezi", file: "shopping centre.png" },
  { word: "MUSEUM", clue: "Müze", file: "museum.png" },
  { word: "ZOO", clue: "Hayvanat bahçesi", file: "zoo.png" },
  { word: "HOSPITAL", clue: "Hastane", file: "hospital.png" },
  { word: "BANK", clue: "Banka", file: "bank.png" },
  { word: "PARK", clue: "Park", file: "park.png" },
  { word: "MOSQUE", clue: "Cami", file: "mosque.png" },
  { word: "CAFE", clue: "Kafe", file: "cafe.png" },
  { word: "POLICESTATION", clue: "Polis merkezi", file: "police station.png" },
  { word: "BUSSTOP", clue: "Otobüs durağı", file: "bus stop.png" },
  { word: "HOME", clue: "Ev", file: "home.png" },
  { word: "ROAD", clue: "Yol", file: "road.png" },
  { word: "MAP", clue: "Harita", file: "map.png" },
  { word: "CITY", clue: "Şehir", file: "city.png" },
  { word: "TOWN", clue: "Kasaba", file: "town.png" },
  { word: "VILLAGE", clue: "Köy", file: "village.png" },
  { word: "AT", clue: "-de / -da", file: "at.png" },
  { word: "OVERTHERE", clue: "Orada", file: "over there.png" },
  { word: "HERE", clue: "Burada", file: "here.png" },
  { word: "KNOW", clue: "Bilmek", file: "know.png" },
  { word: "NOW", clue: "Şimdi", file: "now.png" },
  { word: "IDONTKNOW", clue: "Bilmiyorum", file: "I don't know.png" },
  { word: "SORRY", clue: "Özür dilerim", file: "sorry.png" },
  { word: "EXCUSEME", clue: "Affedersiniz", file: "excuse me.png" },
  { word: "WHERE", clue: "Nerede", file: "where.png" },
  { word: "GO", clue: "Gitmek", file: "go.png" },
  { word: "IT", clue: "O", file: "it.png" },
];
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.7/${vocab.file}` : null;
  ...
  const shareGame = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 7: In My City",
        text: text,
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-7/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
