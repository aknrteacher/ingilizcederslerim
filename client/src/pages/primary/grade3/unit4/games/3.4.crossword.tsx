...
const vocabulary = [
  ...
  { word: "SAD", clue: "Üzgün", file: "unhappy (sad).png" },
  { word: "ANGRY", clue: "Kızgın", file: "angry.png" },
  { word: "SURPRISED", clue: "Şaşkın", file: "surprised.png" },
  { word: "ENERGETIC", clue: "Enerjik", file: "energetic.png" },
  { word: "TIRED", clue: "Yorgun", file: "tired.png" },
  { word: "HUNGRY", clue: "Aç", file: "hungry.png" },
  { word: "THIRSTY", clue: "Susamış", file: "thirrsty.png" },
  { word: "FULL", clue: "Tok", file: "full.png" },
  { word: "BORED", clue: "Sıkılmış", file: "bored.png" },
  { word: "FEEL", clue: "Hissetmek", file: "feel.png" },
  { word: "EAT", clue: "Yemek", file: "eat.png" },
  { word: "DRINK", clue: "İçmek", file: "drink.png" },
  { word: "WALK", clue: "Yürümek", file: "walk.png" },
  { word: "STUDY", clue: "Çalışmak", file: "study.png" },
  { word: "COOK", clue: "Pişirmek", file: "cook.png" },
  { word: "WATCH", clue: "İzlemek", file: "watch.png" },
  ...
  { word: "SING", clue: "Şarkı söylemek", file: "sing a song.png" },
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.4/${vocab.file}` : null;
  }).filter(Boolean) as string[];

  const shareGame = () => {
    const text = `I just solved the Unit 4 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 4: Feelings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 4 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-4/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
