...
// Unit 5 vocabulary - lowercase for typing game
const allVocabulary = [
...
export default function WordRaceGame3_5() {
  ...
  useEffect(() => {
    if (gameOver && wordsTyped >= 10) {
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#44DDCC", "#55EEDD", "#66FFEE", "#77FFFF", "#88FFFF"]
      });
    }
  }, [gameOver, wordsTyped]);
  ...
  return (
    <Layout>
      <div className="word-race-wrapper primary-school-game" id="word-race-game">
        <div className="word-race-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Keyboard className="h-7 w-7 text-teal-600" />}
          />
      ...
      <style>{`
        ...
        .word-input:focus {
          box-shadow: 0 0 0 4px rgba(68, 221, 204, 0.2);
        }
