...
import "@/styles/3.5.crossword.css";
...
// Vocabulary from 3.5 (Unit 5) - Convert multi-word phrases to single words for crossword
const vocabulary = [
  { word: "TOY", clue: "Oyuncak", file: "toy.png" },
  { word: "GAME", clue: "Oyun", file: "game.png" },
  { word: "BALL", clue: "Top", file: "ball.png" },
  { word: "DOLL", clue: "Oyuncak bebek", file: "doll.png" },
  { word: "TEDDYBEAR", clue: "Oyuncak ayı", file: "teddy bear.png" },
  { word: "KITE", clue: "Uçurtma", file: "kite.png" },
  { word: "BLOCKS", clue: "Bloklar", file: "blocks.png" },
  { word: "CHESS", clue: "Satranç", file: "chess.png" },
  { word: "COMPUTER", clue: "Bilgisayar", file: "computer.png" },
  { word: "CARD", clue: "Kart", file: "card.png" },
  ...
  { word: "HOWMANY", clue: "Kaç tane", file: "how many.png" },
  { word: "HAVEGOT", clue: "Sahip olmak", file: "have got.png" },
  { word: "HASGOT", clue: "Sahip olmak", file: "has got.png" },
  { word: "THEREIS", clue: "Var (tekil)", file: "there is.png" },
  { word: "THEREARE", clue: "Var (çoğul)", file: "there are.png" },
  ...
  { word: "YOUR", clue: "Senin", file: "your.png" },
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.5/${vocab.file}` : null;
  }).filter(Boolean) as string[];

  const shareGame = () => {
    const text = `I just solved the Unit 5 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 5",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 5 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
        ...
        <div className="crossword-game-container">
          <>
            ...
            <PrimarySchoolGameHeader 
              gameName="Word Cross"
              description="Grade 3 - Unit 5: Toys and Games"
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-5/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
