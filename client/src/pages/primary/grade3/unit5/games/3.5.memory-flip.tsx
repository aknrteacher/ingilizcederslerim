...
// Unit 5 vocabulary - lowercase for memory game
const allVocabulary = [
...
export default function MemoryFlipGame3_5() {
  ...
  useEffect(() => {
    if (matchedPairs === pairCount && pairCount > 0) {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#CC66FF", "#DD77FF", "#EE88FF", "#FF99FF", "#FFAAFF"]
      });
    }
      ...
      <div className="memory-flip-wrapper primary-school-game" id="memory-flip-game">
        <div className="memory-flip-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Grid3X3 className="h-7 w-7 text-[#CC66FF]" />}
          />
          ...
          <div className="stats-bar">
            ...
            <div className="stat-item">
              <Clock className="h-4 w-4 text-[#CC66FF]" />
                    ...
                    <div className="card-inner">
                      ...
                      <div className="card-back">
                        {card.type === 'word' ? (
                          ...
                          <img src={`/images/primary/3.5/${card.file}`} alt={card.word} />
                        )}
                      </div>
                    </div>
                  </div>
        ...
        .memory-card:hover:not(.flipped):not(.matched) .card-front {
          box-shadow: 0 8px 24px rgba(204, 102, 255, 0.4);
