...
// Unit 5 vocabulary - lowercase for listening game
const allVocabulary = [
...
export default function SayWhatGame3_5() {
  ...
  useEffect(() => {
    if (round > totalRounds && !gameOver) {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#FFBB44", "#FFCC66", "#FFDD88", "#FFEEAA", "#FFFFCC"]
      });
    }
  ...
  const shareGame = () => {
    const text = `I scored ${score} points on Say What? Unit 5! Can you beat me? 🎧`;
    if (navigator.share) {
      navigator.share({ title: "Say What? Unit 5", text, url: window.location.href });
    }
  };
    ...
    <Layout>
      <div className="say-what-wrapper primary-school-game" id="say-what-game">
        <div className="say-what-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Volume2 className="h-7 w-7 text-orange-600" />}
          />
              ...
              <div className="options-grid">
                {options.map((option, index) => (
                  ...
                  >
                    ...
                    <img
                      src={`/images/primary/3.5/${option.file}`}
                      alt={option.word}
                    />
      ...
      <style>{`
        ...
        .listen-btn {
          ...
          font-weight: 600;
          transition: all 0.3s ease;
          box-shadow: 0 8px 24px rgba(255, 187, 68, 0.4);
          position: relative;
          overflow: visible;
        }
        ...
        .listen-btn:hover {
          transform: scale(1.1);
          box-shadow: 0 12px 32px rgba(255, 187, 68, 0.6);
        }
        ...
        .card-glow {
          ...
          width: 200%;
          height: 200%;
          background: radial-gradient(circle, rgba(255, 187, 68, 0.1) 0%, transparent 70%);
          opacity: 0;
