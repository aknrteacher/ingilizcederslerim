...
const vocabulary = [
  ...
  { word: "HOWMANY", turkish: "Kaç tane", file: "how many.png" },
  { word: "HAVEGOT", turkish: "Sahip olmak", file: "have got.png" },
  { word: "HASGOT", turkish: "Sahip olmak", file: "has got.png" },
  { word: "THEREIS", turkish: "Var (tekil)", file: "there is.png" },
  { word: "THEREARE", turkish: "Var (çoğul)", file: "there are.png" },
  ...
  { word: "YOUR", turkish: "Senin", file: "your.png" },
  { word: "IT", turkish: "O", file: "it.png" },
];

// Diverse vibrant colors for balloons - different from each other and from game's light blue theme
const balloonStyles = [
...
export default function WordPopGame3_5() {
  ...
  const nextWord = useCallback(() => {
    if (wordsCompleted + 1 >= totalWords) {
      ...
      confetti({
        ...
        spread: 100,
        origin: { y: 0.6 },
        colors: ["#44CCFF", "#55DDFF", "#66EEFF", "#33BBFF", "#22AAFF"]
      });
      return;
    }
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Word Pop Unit 5! Can you beat my score? 🎈`;
    if (navigator.share) {
      navigator.share({ title: "Word Pop - Unit 5 English Learning Game", text, url: window.location.href });
    } else {
  ...
  return (
    <Layout>
      ...
      >
        {/* Background - Light Blue theme for primary school */}
        <div className="absolute inset-0 bg-[#44CCFF] z-0">
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-[#55DDFF] opacity-50" />
        ...
        <div className="relative z-10 flex flex-col flex-1 min-h-0 p-2 sm:p-4">
          ...
          <AnimatePresence>
            {showCombo && combo >= 2 && (
              ...
              >
                <div className="bg-[#44CCFF] text-white px-6 py-3 rounded-full font-bold text-2xl shadow-lg">
                  🔥 {combo}x Combo!
                </div>
              </motion.div>
            )}
          ...
          <div className="flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#EEF8FF] rounded-xl p-3 sm:p-6 min-h-0 overflow-hidden">
            {/* Target Word Card */}
            <motion.div 
              key={currentWord.word}
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              className="bg-white rounded-3xl shadow-xl p-3 sm:p-4 border-4 border-[#44CCFF] flex-shrink-0 self-center w-full lg:w-auto"
            >
              <div className="w-32 h-32 sm:w-48 sm:h-48 rounded-2xl bg-blue-50 flex items-center justify-center overflow-hidden mb-3 mx-auto">
                <img 
                  src={`/images/primary/3.5/${currentWord.file}`} 
              ...
              <div className="flex items-center justify-center gap-2">
                {showTurkish ? (
                  ...
                  <Button
                    ...
                    className="h-8 px-3 text-blue-500 border-blue-300 hover:bg-blue-50"
              ...
              {!gameStarted && !gameOver && !gameWon && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <Button
                    onClick={startGame}
                    size="lg"
                    className="bg-[#44CCFF] hover:bg-[#33BBFF] text-white text-xl px-8 py-6 rounded-2xl shadow-xl"
                  >
                    🎈 Start Game!
                  </Button>
                </div>
          ...
          <div className="primary-school-game-footer flex-shrink-0 mt-auto">
            <div className="footer-content">
              ...
              <div className="footer-right">
                ...
                <Button variant="outline" className="footer-button" onClick={() => setLocation("/primary-school/grade-3/unit-5/games")}>
                  ← Back
                </Button>
              </div>
            </div>
              ...
              >
                ...
                <div className="bg-blue-50 rounded-xl p-4 mb-6">
                  ...
                  <div className="text-sm space-y-1 border-t border-gray-200 pt-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-blue-600">{wordsCompleted} × {correctPoints} = +{wordsCompleted * correctPoints}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="flex flex-col gap-3">
                  <Button
                    onClick={resetGame}
                    size="lg"
                    className="w-full bg-[#44CCFF] hover:bg-[#33BBFF] text-white rounded-xl"
                  >
                    Play Again
                  </Button>
                  <Button
                    onClick={() => setLocation("/primary-school/grade-3/unit-5/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
