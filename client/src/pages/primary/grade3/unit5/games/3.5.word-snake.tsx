...
// Unit 5 vocabulary - lowercase for snake game
const allVocabulary = [
...
export default function WordSnakeGame3_5() {
        ...
        if (collectedLetters.length + 1 === targetWord.word.length) {
          ...
          if (wordsCompleted + 1 >= 5) {
            ...
            confetti({ 
              ...
              spread: 70, 
              origin: { y: 0.6 },
              colors: ["#FF9944", "#FFAA55", "#FFBB66", "#FFCC77", "#FFDD88"]
            });
          } else {
    ...
    <Layout>
          ...
          {gameStarted && !gameOver && (
            <>
              ...
              <div 
                className="game-grid"
                style={{
                  backgroundImage: targetWord ? `url(/images/primary/3.5/${targetWord.file})` : 'none'
                }}
              >
      ...
      <style>{`
        ...
        .speak-btn-compact:hover {
          transform: scale(1.1);
          box-shadow: 0 3px 10px rgba(255, 153, 68, 0.5);
        }
