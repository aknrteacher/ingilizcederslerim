...
// Unit 3 vocabulary - lowercase for memory game
const allVocabulary = [
  ...
  useEffect(() => {
    if (matchedPairs === pairCount && pairCount > 0) {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#FF44AA", "#FF66BB", "#FF88CC", "#FFAADD", "#FFCCEE"]
      });
    }
      ...
      <div className="memory-flip-wrapper primary-school-game" id="memory-flip-game">
        <div className="memory-flip-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Grid3X3 className="h-7 w-7 text-[#FF6B6B]" />}
          />
                    ...
                    <div className="card-inner">
                      ...
                      <div className="card-back">
                        {card.type === 'word' ? (
                          ...
                          <img src={`/images/primary/3.3/${card.file}`} alt={card.word} />
                        )}
                      </div>
                    </div>
                  </div>
        ...
        .memory-card:hover:not(.flipped):not(.matched) .card-front {
          box-shadow: 0 8px 24px rgba(255, 68, 170, 0.4);
