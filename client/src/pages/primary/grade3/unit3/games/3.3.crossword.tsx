...
const vocabulary = [
  ...
  { word: "TALL", clue: "Uzun", file: "tall.png" },
  { word: "SHORT", clue: "Kısa", file: "short.png" },
  { word: "FAT", clue: "Şişman", file: "fat.png" },
  { word: "SLIM", clue: "İnce", file: "slim.png" },
  { word: "STRONG", clue: "Güçlü", file: "strong.png" },
  { word: "WEAK", clue: "Zayıf", file: "weak.png" },
  { word: "OLD", clue: "Yaşlı", file: "old.png" },
  { word: "YOUNG", clue: "Genç", file: "young.png" },
  { word: "FAST", clue: "Hızlı", file: "fast.png" },
  { word: "SLOW", clue: "Yavaş", file: "slow.png" },
  { word: "SUPERHERO", clue: "Süper kahraman", file: "superhero.png" },
  { word: "PLAY", clue: "Oynamak", file: "play.png" },
  { word: "RUN", clue: "Koşmak", file: "run.png" },
  { word: "WALK", clue: "Yürümek", file: "walk.png" },
  { word: "JUMP", clue: "Zıplamak", file: "jump.png" },
  { word: "SWIM", clue: "Yüzmek", file: "swim.png" },
  { word: "FLY", clue: "Uçmak", file: "fly.png" },
  { word: "CLIMB", clue: "Tırmanmak", file: "climb.png" },
  { word: "DANCE", clue: "Dans etmek", file: "dance.png" },
  { word: "SING", clue: "Şarkı söylemek", file: "sing.png" },
  { word: "DRAW", clue: "Çizmek", file: "draw.png" },
  { word: "TALK", clue: "Konuşmak", file: "talk.png" },
  { word: "RIDE", clue: "Binmek", file: "ride.png" },
  { word: "CARRY", clue: "Taşımak", file: "carry.png" },
  { word: "LIFT", clue: "Kaldırmak", file: "lift.png" },
  { word: "BIKE", clue: "Bisiklet", file: "bike.png" },
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.3/${vocab.file}` : null;
  ...
  const shareGame = () => {
    const text = `I just solved the Unit 3 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 3",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 3 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-3/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
