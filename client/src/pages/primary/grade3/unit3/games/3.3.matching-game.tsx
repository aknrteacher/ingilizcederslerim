...
import "@/styles/3.3.matching-game.css";
...
export default function MatchingGame() {
  ...
  const allVocabulary = [
    ...
    { word: "tall", file: "tall.png", turkish: "uzun" },
    ...
    { word: "weak", file: "weak.png", turkish: "zayıf" },
    ...
    { word: "superhero", file: "superhero.png", turkish: "süper kahraman" },
    ...
    { word: "climb", file: "climb.png", turkish: "tırmanmak" },
    { word: "dance", file: "dance.png", turkish: "dans etmek" },
    { word: "sing", file: "sing.png", turkish: "şarkı söylemek" },
    { word: "draw", file: "draw.png", turkish: "çizmek" },
    { word: "talk", file: "talk.png", turkish: "konuşmak" },
    { word: "ride", file: "ride.png", turkish: "binmek" },
    { word: "carry", file: "carry.png", turkish: "taşımak" },
    { word: "lift", file: "lift.png", turkish: "kaldırmak" },
    { word: "bike", file: "bike.png", turkish: "bisiklet" },
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/primary/3.3/${item.file}`,
  ...
  const shareGame = () => {
    const text = `I just scored ${formatTime(elapsedTime)} on Matchlings Unit 3! Can you beat my time? 🎮`;
    if (navigator.share) {
      navigator.share({
        title: "Matchlings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Matchlings Unit 3! Can you match all the words faster than my ${formatTime(elapsedTime)}? 🏆`;
    if (navigator.share) {
      navigator.share({
        ...
        <div className="matching-game-container">
          <>
            <PrimarySchoolGameHeader 
              ...
              icon={<Puzzle className="h-7 w-7 text-purple-600" />}
            />
            
            <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto justify-between sm:justify-end flex-wrap mb-4">
              <div className="flex items-center gap-2 bg-purple-100 px-2 sm:px-3 py-1 rounded-lg">
                <Trophy className="h-3 w-3 sm:h-4 sm:w-4 text-purple-600" />
                <span className="font-bold text-purple-700 text-sm sm:text-base">{matches.length} / {selectedCards.length}</span>
              </div>
              
              <div className="bg-purple-100 px-2 sm:px-3 py-1 rounded-lg flex items-center gap-1 sm:gap-2">
                <Clock className="h-3 w-3 sm:h-4 sm:w-4 text-purple-600" />
                <span className="font-bold text-purple-700 text-sm sm:text-base" data-testid="text-timer">
                  ...
                  <div className="win-modal">
                    <div className="win-content">
                      ...
                      <div className="win-buttons">
                        ...
                        <Button variant="ghost" onClick={() => setLocation("/primary-school/grade-3/unit-3/games")} className="btn-secondary">
                          Back to Games
                        </Button>
                      </div>
                    </div>
