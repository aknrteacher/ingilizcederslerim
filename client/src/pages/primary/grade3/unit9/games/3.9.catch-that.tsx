...
// Unit 9 vocabulary - uppercase keys for catch-that
const vocabulary = [
  ...
  { word: "WARM", turkish: "Ilık", file: "warm.png" },
  { word: "NICE", turkish: "Güzel", file: "nice.png" },
  { word: "DRY", turkish: "Kuru", file: "dry.png" },
  { word: "WET", turkish: "Islak", file: "wet.png" },
  { word: "SPRING", turkish: "İlkbahar", file: "spring.png" },
  ...
  { word: "TOMORROW", turkish: "Yarın", file: "tomorrow.png" },
  { word: "NOW", turkish: "Şimdi", file: "now.png" },
  { word: "SUN", turkish: "Güneş", file: "sun.png" },
  { word: "RAIN", turkish: "Yağmur", file: "rain.png" },
  { word: "SNOW", turkish: "Kar", file: "snow.png" },
  { word: "CLOUD", turkish: "Bulut", file: "cloud.png" },
  { word: "DESERT", turkish: "Çöl", file: "desert.png" },
  { word: "POLE", turkish: "Kutup", file: "pole.png" },
  { word: "JUNGLE", turkish: "Orman", file: "jungle.png" },
  { word: "HOW", turkish: "Nasıl", file: "how.png" },
  { word: "GOHOME", turkish: "Eve gitmek", file: "go home.png" },
  { word: "GOOUT", turkish: "Dışarı çıkmak", file: "go out.png" },
...
export default function CatchThatGame3_9() {
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={'/images/primary/3.9/' + currentWord.file} 
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-3/unit-9/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
