...
const vocabulary = [
  ...
  { word: "WARM", clue: "Ilık", file: "warm.png" },
  { word: "NICE", clue: "Güzel", file: "nice.png" },
  { word: "DRY", clue: "Kuru", file: "dry.png" },
  { word: "WET", clue: "Islak", file: "wet.png" },
  { word: "SPRING", clue: "İlkbahar", file: "spring.png" },
  ...
  { word: "TOMORROW", clue: "Yarın", file: "tomorrow.png" },
  { word: "NOW", clue: "Şimdi", file: "now.png" },
  { word: "SUN", clue: "Güneş", file: "sun.png" },
  { word: "RAIN", clue: "Yağmur", file: "rain.png" },
  { word: "SNOW", clue: "Kar", file: "snow.png" },
  { word: "CLOUD", clue: "Bulut", file: "cloud.png" },
  { word: "DESERT", clue: "Çöl", file: "desert.png" },
  { word: "POLE", clue: "Kutup", file: "pole.png" },
  { word: "JUNGLE", clue: "Orman", file: "jungle.png" },
  { word: "HOW", clue: "Nasıl", file: "how.png" },
  { word: "GOHOME", clue: "Eve gitmek", file: "go home.png" },
  { word: "GOOUT", clue: "Dışarı çıkmak", file: "go out.png" },
  { word: "VERY", clue: "Çok", file: "very.png" },
];
...
export default function CrosswordGame() {
  ...
  const shareGame = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 9: Weather",
        text: text,
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-9/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
