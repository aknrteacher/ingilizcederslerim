...
export default function CrosswordGame() {
  ...
  const shareGame = () => {
    const text = `I just solved the Unit 1 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 1",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 1 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
