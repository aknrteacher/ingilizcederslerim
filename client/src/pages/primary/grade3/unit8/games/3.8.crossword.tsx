...
// Vocabulary from 3.8 (Unit 8: Transportation)
const vocabulary = [
  { word: "VEHICLE", clue: "Araç", file: "vehicle.png" },
  { word: "CAR", clue: "Araba", file: "car.png" },
  { word: "BUS", clue: "Otobüs", file: "bus.png" },
  { word: "TRAIN", clue: "Tren", file: "train.png" },
  { word: "TRUCK", clue: "Kamyon", file: "truck.png" },
  { word: "PLANE", clue: "Uçak", file: "plane.png" },
  { word: "SUBWAY", clue: "Metro", file: "subway.png" },
  { word: "SHIP", clue: "Gemi", file: "ship.png" },
  { word: "BOAT", clue: "Tekne", file: "boat.png" },
  { word: "BICYCLEBIKE", clue: "Bisiklet", file: "bicycle (bike).png" },
  { word: "MOTORBIKE", clue: "Motosiklet", file: "motorbike.png" },
  { word: "HELICOPTER", clue: "Helikopter", file: "helicopter.png" },
  { word: "DRIVE", clue: "Araba kullanmak", file: "drive.png" },
  { word: "RIDE", clue: "Binmek", file: "ride.png" },
  { word: "FLY", clue: "Uçmak", file: "fly.png" },
  { word: "GO", clue: "Gitmek", file: "go.png" },
  { word: "STOP", clue: "Durmak", file: "stop.png" },
  { word: "AIR", clue: "Hava", file: "air.png" },
  { word: "SKY", clue: "Gökyüzü", file: "sky.png" },
  { word: "ROAD", clue: "Yol", file: "road.png" },
  { word: "SEA", clue: "Deniz", file: "sea.png" },
  { word: "MAP", clue: "Harita", file: "map.png" },
  { word: "TRANSPORTATION", clue: "Ulaşım", file: "transportation.png" },
  { word: "BYBUS", clue: "Otobüsle", file: "by bus.png" },
  { word: "BYCAR", clue: "Arabayla", file: "by car.png" },
  { word: "BYTRAIN", clue: "Trenle", file: "by train.png" },
  { word: "HOW", clue: "Nasıl", file: "how.png" },
  { word: "WHERE", clue: "Nerede", file: "where.png" },
  { word: "HERE", clue: "Burada", file: "here.png" },
  { word: "EXCUSEME", clue: "Affedersiniz", file: "excuse me.png" },
];
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.8/${vocab.file}` : null;
  ...
  const shareGame = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 8: Transportation",
        text: text,
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-8/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
