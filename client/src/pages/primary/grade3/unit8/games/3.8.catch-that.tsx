...
// Unit 8 vocabulary - uppercase single words for catch-that
const vocabulary = [
  { word: "VEHICLE", turkish: "Araç", file: "vehicle.png" },
  { word: "CAR", turkish: "Araba", file: "car.png" },
  { word: "BUS", turkish: "Otobüs", file: "bus.png" },
  { word: "TRAIN", turkish: "Tren", file: "train.png" },
  { word: "TRUCK", turkish: "Kamyon", file: "truck.png" },
  { word: "PLANE", turkish: "Uçak", file: "plane.png" },
  { word: "SUBWAY", turkish: "Metro", file: "subway.png" },
  { word: "SHIP", turkish: "Gemi", file: "ship.png" },
  { word: "BOAT", turkish: "Tekne", file: "boat.png" },
  { word: "BICYCLEBIKE", turkish: "Bisiklet", file: "bicycle (bike).png" },
  { word: "MOTORBIKE", turkish: "Motosiklet", file: "motorbike.png" },
  { word: "HELICOPTER", turkish: "Helikopter", file: "helicopter.png" },
  { word: "DRIVE", turkish: "Araba kullanmak", file: "drive.png" },
  ...
  { word: "AIR", turkish: "Hava", file: "air.png" },
  ...
  { word: "TRANSPORTATION", turkish: "Ulaşım", file: "transportation.png" },
  { word: "BYBUS", turkish: "Otobüsle", file: "by bus.png" },
  { word: "BYCAR", turkish: "Arabayla", file: "by car.png" },
  { word: "BYTRAIN", turkish: "Trenle", file: "by train.png" },
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-[#FFEEDD] rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-64 h-64 ' : '') + 'rounded-2xl bg-orange-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={'/images/primary/3.8/' + currentWord.file} 
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-3/unit-8/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
