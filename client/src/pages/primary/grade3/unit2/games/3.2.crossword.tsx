...
import "@/styles/3.2.crossword.css";
...
const vocabulary = [
  ...
  { word: "MOTHER", clue: "Anne", file: "mother.png" },
  { word: "BROTHER", clue: "Erkek kardeş", file: "brother.png" },
  { word: "SISTER", clue: "Kız kardeş", file: "sister.png" },
  { word: "SON", clue: "Oğul", file: "son.png" },
  { word: "DAUGHTER", clue: "Kız", file: "daughter.png" },
  { word: "UNCLE", clue: "Amca/dayı", file: "uncle.png" },
  { word: "AUNT", clue: "Hala/teyze", file: "aunt.png" },
  { word: "GRANDFATHER", clue: "Büyükbaba", file: "grandfather.png" },
  { word: "GRANDMOTHER", clue: "Büyükanne", file: "grandmother.png" },
  { word: "COUSIN", clue: "Kuzen", file: "cousin.png" },
  { word: "CHILDREN", clue: "Çocuklar", file: "children.png" },
  { word: "GRANDCHILDREN", clue: "Torunlar", file: "grandchildren.png" },
  { word: "WHO", clue: "Kim", file: "who.png" },
  { word: "THIS", clue: "Bu", file: "this.png" },
  { word: "THAT", clue: "Şu/o", file: "that.png" },
  { word: "SAY", clue: "Söylemek", file: "say.png" },
  { word: "STUDENT", clue: "Öğrenci", file: "student.png" },
  { word: "AGE", clue: "Yaş", file: "age.png" },
  { word: "HOWOLDISHE", clue: "O kaç yaşında?", file: "how old is he.png" },
  { word: "YEARSOLD", clue: "Yaşında", file: "years old.png" },
  { word: "MY", clue: "Benim", file: "my.png" },
  { word: "NAME", clue: "Isim", file: "name.png" },
  { word: "IS", clue: "Dır/dir", file: "is.png" },
  { word: "HASGOT", clue: "Sahip", file: "has got.png" },
  { word: "INTRODUCE", clue: "Tanıtmak", file: "introduce.png" },
  { word: "PEOPLE", clue: "İnsanlar", file: "people.png" },
...
export default function CrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/3.2/${vocab.file}` : null;
  ...
  const shareGame = () => {
    const text = `I just solved the Unit 2 Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Unit 2",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Unit 2 Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
  ...
  const handleCellChange = (r: number, c: number, val: string) => {
    ...
    if (isAllCorrect && totalCount > 0) {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#4444FF", "#5555FF", "#6666FF", "#10b981"]
      });
    }
  };
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-3/unit-2/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
