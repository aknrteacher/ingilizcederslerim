...
// Unit 2 vocabulary - lowercase for memory game
const allVocabulary = [
      ...
      <div className="memory-flip-wrapper primary-school-game" id="memory-flip-game">
        <div className="memory-flip-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Grid3X3 className="h-7 w-7 text-[#FF44AA]" />}
          />
          ...
          <div className="stats-bar">
            ...
            <div className="stat-item">
              <Clock className="h-4 w-4 text-[#FF44AA]" />
                    ...
                    <div className="card-inner">
                      ...
                      <div className="card-back">
                        {card.type === 'word' ? (
                          ...
                          <img src={`/images/primary/3.2/${card.file}`} alt={card.word} />
                        )}
                      </div>
                    </div>
                  </div>
