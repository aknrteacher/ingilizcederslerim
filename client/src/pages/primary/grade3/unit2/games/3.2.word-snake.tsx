        ...
        if (collectedLetters.length + 1 === targetWord.word.length) {
          ...
          if (wordsCompleted + 1 >= 5) {
            ...
            confetti({ 
              ...
              spread: 70, 
              origin: { y: 0.6 },
              colors: ["#FF44FF", "#FF66FF", "#FF88FF", "#FFAAFF", "#FFCCFF"]
            });
          } else {
    ...
    <Layout>
          ...
          {gameStarted && !gameOver && (
            <>
              ...
              <div 
                className="game-grid"
                style={{
                  backgroundImage: targetWord ? `url(/images/primary/3.2/${targetWord.file})` : 'none'
                }}
              >
      ...
      <style>{`
        ...
        .speak-btn-compact {
          ...
          align-items: center;
          justify-content: center;
          box-shadow: 0 2px 6px rgba(255, 68, 255, 0.4);
        ...
        .speak-btn-compact:hover {
          transform: scale(1.1);
          box-shadow: 0 3px 10px rgba(255, 68, 255, 0.5);
        }
