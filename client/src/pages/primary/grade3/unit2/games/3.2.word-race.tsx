...
// Unit 2 vocabulary - lowercase for typing game
const allVocabulary = [
  ...
  useEffect(() => {
    if (gameOver && wordsTyped >= 10) {
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#FFFF44", "#EEEE33", "#DDDD22", "#CCCC11", "#BBBB00"]
      });
    }
  }, [gameOver, wordsTyped]);
  ...
  return (
    <Layout>
      <div className="word-race-wrapper primary-school-game" id="word-race-game">
        <div className="word-race-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Keyboard className="h-7 w-7 text-[#FFFF44]" />}
          />
          ...
          {gameStarted && !gameOver && (
            <>
              ...
              <div className="stats-bar">
                ...
                <div className="stat-item">
                  <Clock className="h-4 w-4 text-[#FFFF44]" />
      ...
      <style>{`
        ...
        .word-input:focus {
          box-shadow: 0 0 0 4px rgba(255, 255, 68, 0.2);
        }
