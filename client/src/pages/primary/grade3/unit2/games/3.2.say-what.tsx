...
// Unit 2 vocabulary - lowercase for listening game
const allVocabulary = [
  ...
  useEffect(() => {
    if (round > totalRounds && !gameOver) {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ["#00FFFF", "#00CCCC", "#00DDDD", "#00EEEE", "#00AAAA"]
      });
    }
  ...
  return (
    <Layout>
      <div className="say-what-wrapper primary-school-game" id="say-what-game">
        <div className="say-what-container">
          <PrimarySchoolGameHeader
            ...
            icon={<Volume2 className="h-7 w-7 text-[#00FFFF]" />}
          />
              ...
              <div className="options-grid">
                {options.map((option, index) => (
                  ...
                  >
                    ...
                    <img
                      src={`/images/primary/3.2/${option.file}`}
                      alt={option.word}
                    />
      ...
      <style>{`
        ...
        .listen-btn:hover {
          transform: scale(1.1);
          box-shadow: 0 12px 32px rgba(0, 255, 255, 0.6);
        }
