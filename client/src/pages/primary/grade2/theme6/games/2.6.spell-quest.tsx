...
const vocabulary: VocabWord[] = [
  ...
  { word: "ORANGE", displayWord: "orange", turkish: "portakal", file: "orange.png" },
  { word: "BANANA", displayWord: "banana", turkish: "muz", file: "banana.png" },
  { word: "CHERRY", displayWord: "cherry", turkish: "kiraz", file: "cherry.png" },
  { word: "GRAPES", displayWord: "grapes", turkish: "üzüm", file: "grapes.png" },
  { word: "PEAR", displayWord: "pear", turkish: "armut", file: "pear.png" },
  { word: "STRAWBERRY", displayWord: "strawberry", turkish: "çilek", file: "strawberry.png" },
  { word: "VEGETABLE", displayWord: "vegetable", turkish: "sebze", file: "vegetable.png" },
  { word: "TOMATOES", displayWord: "tomatoes", turkish: "domatesler", file: "tomatoes.png" },
  { word: "POTATOES", displayWord: "potatoes", turkish: "patatesler", file: "potatoes.png" },
  { word: "CUCUMBER", displayWord: "cucumber", turkish: "salatalık", file: "cucumber.png" },
  { word: "PEPPER", displayWord: "pepper", turkish: "biber", file: "pepper.png" },
  { word: "BROCCOLI", displayWord: "broccoli", turkish: "brokoli", file: "broccoli.png" },
  { word: "CARROT", displayWord: "carrot", turkish: "havuç", file: "carrot.png" },
  { word: "WATER", displayWord: "water", turkish: "su", file: "water.png" },
  { word: "MILK", displayWord: "milk", turkish: "süt", file: "milk.png" },
  { word: "TEA", displayWord: "tea", turkish: "çay", file: "tea.png" },
  { word: "COFFEE", displayWord: "coffee", turkish: "kahve", file: "coffee.png" },
  { word: "LIKE", displayWord: "like", turkish: "sevmek", file: "like.png" },
  { word: "FRIDGE", displayWord: "fridge", turkish: "buzdolabı", file: "fridge.png" },
  { word: "BREAKFAST", displayWord: "breakfast", turkish: "kahvaltı", file: "breakfast.png" },
  { word: "LUNCH", displayWord: "lunch", turkish: "öğle yemeği", file: "lunch.png" },
  { word: "DINNER", displayWord: "dinner", turkish: "akşam yemeği", file: "dinner.png" },
  { word: "BREAD", displayWord: "bread", turkish: "ekmek", file: "bread.png" },
  { word: "FISH", displayWord: "fish", turkish: "balık", file: "fish.png" },
  { word: "CHICKEN", displayWord: "chicken", turkish: "tavuk", file: "chicken.png" },
  { word: "MEAT", displayWord: "meat", turkish: "et", file: "meat.png" },
  { word: "EGG", displayWord: "egg", turkish: "yumurta", file: "egg.png" },
  { word: "HUNGRY", displayWord: "hungry", turkish: "aç", file: "hungry.png" },
  { word: "THIRSTY", displayWord: "thirsty", turkish: "susuz", file: "thirsty.png" },
  { word: "YUMMY", displayWord: "yummy", turkish: "lezzetli", file: "yummy.png" },
];
...
export default function SpellQuestGame2_6() {
          ...
          {!gameComplete && currentWord && (
            <div className="game-main">
              ...
              <div className="picture-area">
                ...
                >
                  <img 
                    src={`/images/primary/2.6/${currentWord.file}`} 
