...
export default function MatchingGame2_6() {
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/primary/2.6/${item.file}`,
                  ...
                  <div className="win-modal">
                    <div className="win-content">
                      ...
                      <div className="win-buttons">
                        ...
                        <Button variant="ghost" onClick={() => setLocation("/primary-school/grade-2/theme-6/games")} className="btn-secondary">
                          Back to Games
                        </Button>
                      </div>
                    </div>
