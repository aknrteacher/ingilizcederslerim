...
const vocabulary = [
  ...
  { word: "STRAWBERRY", turkish: "çilek", file: "strawberry.png" },
  { word: "VEGETABLE", turkish: "sebze", file: "vegetable.png" },
  { word: "TOMATOES", turkish: "domatesler", file: "tomatoes.png" },
  { word: "POTATOES", turkish: "patatesler", file: "potatoes.png" },
  { word: "CUCUMBER", turkish: "salatalık", file: "cucumber.png" },
  { word: "PEPPER", turkish: "biber", file: "pepper.png" },
  { word: "BROCCOLI", turkish: "brokoli", file: "broccoli.png" },
  { word: "CARROT", turkish: "havuç", file: "carrot.png" },
  { word: "WATER", turkish: "su", file: "water.png" },
  { word: "MILK", turkish: "süt", file: "milk.png" },
  { word: "TEA", turkish: "çay", file: "tea.png" },
  { word: "COFFEE", turkish: "kahve", file: "coffee.png" },
  ...
  { word: "THIRSTY", turkish: "susuz", file: "thirsty.png" },
  { word: "YUMMY", turkish: "lezzetli", file: "yummy.png" },
];
...
export default function CatchThatGame2_6() {
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    onClick={() => setLocation("/primary-school/grade-2/theme-6/games")}
                    variant="ghost"
                    size="lg"
                    className="w-full"
                  >
