...
const vocabulary = [
  ...
  { word: "STRAWBERRY", clue: "Çilek", file: "strawberry.png" },
  { word: "VEGETABLE", clue: "Sebze", file: "vegetable.png" },
  { word: "TOMATOES", clue: "Domatesler", file: "tomatoes.png" },
  { word: "POTATOES", clue: "Patatesler", file: "potatoes.png" },
  { word: "CUCUMBER", clue: "Salatalık", file: "cucumber.png" },
  { word: "PEPPER", clue: "Biber", file: "pepper.png" },
  { word: "BROCCOLI", clue: "Brokoli", file: "broccoli.png" },
  { word: "CARROT", clue: "Havuç", file: "carrot.png" },
  { word: "WATER", clue: "Su", file: "water.png" },
  { word: "MILK", clue: "Süt", file: "milk.png" },
  { word: "TEA", clue: "Çay", file: "tea.png" },
  { word: "COFFEE", clue: "Kahve", file: "coffee.png" },
  ...
  { word: "THIRSTY", clue: "Susuz", file: "thirsty.png" },
  { word: "YUMMY", clue: "Lezzetli", file: "yummy.png" },
];
...
export default function CrosswordGame2_6() {
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-2/theme-6/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
