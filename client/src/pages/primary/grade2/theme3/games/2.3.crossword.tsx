...
// Vocabulary from 2.3 (Personal Life) - convert multi-word to single word for crossword
const vocabulary = [
  { word: "BODY", clue: "Vücut", file: "body.png" },
  { word: "HEAD", clue: "Baş", file: "head.png" },
  ...
  { word: "BLONDE", clue: "Sarı", file: "blonde.png" },
  ...
  { word: "COAT", clue: "Palto", file: "coat.png" },
  { word: "SHOES", clue: "Ayakkabılar", file: "shoes.png" },
  { word: "DRESS", clue: "Elbise", file: "dress.png" },
  { word: "HAT", clue: "Şapka", file: "hat.png" },
  { word: "WEATHER", clue: "Hava", file: "weather.png" },
  ...
  { word: "BREAK", clue: "Mola", file: "break.png" },
  { word: "PUPPET", clue: "Kukla", file: "puppet.png" },
  { word: "WELLDONE", clue: "Aferin", file: "well done.png" },
];
...
export default function CrosswordGame2_3() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/primary/2.3/${vocab.file}` : null;
  ...
  const shareGame = () => {
    const text = `I just solved the Personal Life Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Personal Life",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Personal Life Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-2/theme-3/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
