...
const vocabulary: VocabWord[] = [
  { word: "BODY", displayWord: "body", turkish: "vücut", file: "body.png" },
  { word: "HEAD", displayWord: "head", turkish: "baş", file: "head.png" },
  { word: "HAIR", displayWord: "hair", turkish: "saç", file: "hair.png" },
  { word: "FACE", displayWord: "face", turkish: "yüz", file: "face.png" },
  { word: "EYES", displayWord: "eyes", turkish: "gözler", file: "eyes.png" },
  { word: "MOUTH", displayWord: "mouth", turkish: "ağız", file: "mouth.png" },
  { word: "EARS", displayWord: "ears", turkish: "kulaklar", file: "ears.png" },
  { word: "ARMS", displayWord: "arms", turkish: "kollar", file: "arms.png" },
  { word: "HANDS", displayWord: "hands", turkish: "eller", file: "hands.png" },
  { word: "LEGS", displayWord: "legs", turkish: "bacaklar", file: "legs.png" },
  { word: "NOSE", displayWord: "nose", turkish: "burun", file: "nose.png" },
  { word: "BLONDE", displayWord: "blonde", turkish: "sarı", file: "blonde.png" },
  { word: "SHIRT", displayWord: "shirt", turkish: "gömlek", file: "shirt.png" },
  { word: "GLASSES", displayWord: "glasses", turkish: "gözlük", file: "glasses.png" },
  { word: "SCARF", displayWord: "scarf", turkish: "atkı", file: "scarf.png" },
  { word: "GLOVES", displayWord: "gloves", turkish: "eldiven", file: "gloves.png" },
  { word: "UMBRELLA", displayWord: "umbrella", turkish: "şemsiye", file: "umbrella.png" },
  { word: "COAT", displayWord: "coat", turkish: "palto", file: "coat.png" },
  { word: "SHOES", displayWord: "shoes", turkish: "ayakkabılar", file: "shoes.png" },
  { word: "DRESS", displayWord: "dress", turkish: "elbise", file: "dress.png" },
  { word: "HAT", displayWord: "hat", turkish: "şapka", file: "hat.png" },
  { word: "WEATHER", displayWord: "weather", turkish: "hava", file: "weather.png" },
  { word: "HOT", displayWord: "hot", turkish: "sıcak", file: "hot.png" },
  { word: "COLD", displayWord: "cold", turkish: "soğuk", file: "cold.png" },
  { word: "SUNNY", displayWord: "sunny", turkish: "güneşli", file: "sunny.png" },
  { word: "RAINY", displayWord: "rainy", turkish: "yağmurlu", file: "rainy.png" },
  { word: "SNOWY", displayWord: "snowy", turkish: "karlı", file: "snowy.png" },
  { word: "BREAK", displayWord: "break", turkish: "mola", file: "break.png" },
  { word: "PUPPET", displayWord: "puppet", turkish: "kukla", file: "puppet.png" },
  { word: "WELLDONE", displayWord: "well done", turkish: "aferin", file: "well done.png" },
];
...
export default function SpellQuestGame2_3() {
