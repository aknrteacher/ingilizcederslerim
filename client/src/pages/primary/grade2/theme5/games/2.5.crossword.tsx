...
// Vocabulary from 2.5 (Homes, Houses, Neighbourhoods) - convert multi-word to single word for crossword
const vocabulary = [
  { word: "HOUSE", clue: "Ev", file: "house.png" },
  { word: "GARDEN", clue: "Bahçe", file: "garden.png" },
  { word: "LIVINGROOM", clue: "Oturma odası", file: "living room.png" },
  { word: "DININGROOM", clue: "Yemek odası", file: "dining room.png" },
  ...
  { word: "COFFEETABLE", clue: "Sehpa", file: "coffee table.png" },
  { word: "DOG", clue: "Köpek", file: "dog.png" },
  { word: "CAT", clue: "Kedi", file: "cat.png" },
  { word: "GOLDFISH", clue: "Japon balığı", file: "goldfish.png" },
  { word: "BIRD", clue: "Kuş", file: "bird.png" },
  { word: "RABBIT", clue: "Tavşan", file: "rabbit.png" },
  { word: "TURTLE", clue: "Kaplumbağa", file: "turtle.png" },
  { word: "PAW", clue: "Pati", file: "paw.png" },
  { word: "CLAW", clue: "Pençe", file: "claw.png" },
  { word: "TAIL", clue: "Kuyruk", file: "tail.png" },
  { word: "WHISKERS", clue: "Bıyık", file: "whiskers.png" },
  { word: "BEAK", clue: "Gaga", file: "beak.png" },
  { word: "FUR", clue: "Kürk", file: "fur.png" },
  { word: "WINGS", clue: "Kanatlar", file: "wings.png" },
  { word: "WHERE", clue: "Nerede", file: "where.png" },
  { word: "FIND", clue: "Bul", file: "find.png" },
...
export default function CrosswordGame2_5() {
  ...
  const collageImages = placedWords.map(pw => {
      const vocab = vocabulary.find(v => v.word === pw.word);
              return vocab?.file ? `/images/primary/2.5/${vocab.file}` : null;
  }).filter(Boolean) as string[];

  const shareGame = () => {
    const text = `I just solved the Homes, Houses, Neighbourhoods Word Cross! Can you beat it? 🧩`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Homes, Houses, Neighbourhoods",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Homes, Houses, Neighbourhoods Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button onClick={() => setLocation("/primary-school/grade-2/theme-5/games")} variant="ghost" size="lg" className="w-full text-slate-600 hover:bg-slate-50 rounded-xl">
                      Back to Games
                    </Button>
                  </div>
                </motion.div>
