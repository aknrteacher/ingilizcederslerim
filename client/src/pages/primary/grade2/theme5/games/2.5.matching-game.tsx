...
export default function MatchingGame2_5() {
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/primary/2.5/${item.file}`,
  ...
  const shareGame = () => {
    const text = `I just scored ${formatTime(elapsedTime)} on Matchlings Homes & Houses! Can you beat my time? 🎮`;
    if (navigator.share) {
      navigator.share({
        title: "Matchlings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Matchlings Homes & Houses! Can you match all the words faster than my ${formatTime(elapsedTime)}? 🏆`;
    if (navigator.share) {
      navigator.share({
        ...
        <div className="matching-game-container">
          <>
            <PrimarySchoolGameHeader 
              gameName="Matchlings"
              description="Grade 2 - Theme 5: Homes, Houses, Neighbourhoods"
                  ...
                  <div className="win-modal">
                    <div className="win-content">
                      ...
                      <div className="win-buttons">
                        ...
                        <Button variant="ghost" onClick={() => setLocation("/primary-school/grade-2/theme-5/games")} className="btn-secondary">
                          Back to Games
                        </Button>
                      </div>
                    </div>
