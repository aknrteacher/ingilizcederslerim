...
export default function PrimarySchoolGrade2Theme4GamesMenu() {
  ...
  const gameCombinations = gameTypes.map((gameType) => ({
    ...
    path: `/primary-school/grade-2/theme-4/${gameType.pathSuffix}`,
    ...
    <Layout>
      <div className="oyunlar-container">
        <div className="oyunlar-header">
          <div>
            <h1 className="oyunlar-title">2. Sınıf - Tema 4: Aile Hayatı</h1>
            <p className="oyunlar-subtitle">Aile hayatıyla ilgili kelimeleri öğren ve oyunlarla pekiştir</p>
          </div>
        </div>
