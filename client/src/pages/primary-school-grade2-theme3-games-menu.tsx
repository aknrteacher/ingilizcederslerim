...
export default function PrimarySchoolGrade2Theme3GamesMenu() {
  ...
  const topic = {
    value: "2.3",
    label: "Kişisel Hayat (Personal Life)",
    image: topic2_3,
  };
  ...
  const gameCombinations = gameTypes.map((gameType) => ({
    ...
    path: `/primary-school/grade-2/theme-3/${gameType.pathSuffix}`,
