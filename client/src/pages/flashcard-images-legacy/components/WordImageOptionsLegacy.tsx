...
import RefreshIcon from '@/pages/flashcard-images/components/icons/RefreshIcon';
import CheckIcon from '@/pages/flashcard-images/components/icons/CheckIcon';
...
interface WordImageOptionsLegacyProps {
  word: string;
  data: WordImageData;
...
const WordImageOptionsLegacy: React.FC<WordImageOptionsLegacyProps> = ({
  word,
  data,
  onImageSelect,
  onRegenerate,
    ...
    <div className="bg-neutral-900 p-8 rounded-3xl shadow-xl border border-neutral-700 w-full animate-fade-in mb-8">
      <div className="flex flex-wrap justify-between items-center gap-6 mb-8">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-amber-900/80 text-amber-100 rounded-2xl flex items-center justify-center text-xl font-black shadow-lg border border-amber-700/50">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <span className="text-[10px] font-black text-amber-200/90 uppercase tracking-widest">{style} — Legacy prompt</span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        <div className="md:col-span-4 lg:col-span-3 space-y-4">
          <div className="p-5 bg-neutral-800 rounded-2xl border border-neutral-600">
            <label className="block text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-3">Refine Description</label>
            <input
              type="text"
              value={clarification}
                  ...
                  return (
                    <div
                      ...
                      className={`group relative flex flex-col bg-neutral-800 p-3 rounded-2xl border-4 transition-all duration-300 ${
                        isSelected
                          ? 'border-amber-600/90 shadow-2xl scale-[1.03] z-10'
                    ...
                    >
                      ...
                      >
                        <img src={src} alt={`${word} variation ${index + 1}`} className="w-full h-full object-contain" />
                        {isSelected && (
                          <div className="absolute top-2 right-2 bg-amber-600 text-black rounded-full p-1.5 shadow-xl z-20">
                        ...
                        {!isSelected && (
                          <div className="absolute inset-0 bg-neutral-600/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-xl pointer-events-none">
                            <span className="bg-neutral-800 text-white font-black text-[10px] px-3 py-1.5 rounded-full shadow-lg uppercase tracking-widest">
                              Select
                            </span>
                          </div>
                        )}
...
export default WordImageOptionsLegacy;
