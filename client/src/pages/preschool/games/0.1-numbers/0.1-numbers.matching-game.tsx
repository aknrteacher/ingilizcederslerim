...
export default function NumbersMatchingGame() {
  const [, setLocation] = useLocation();
  const allVocabulary = [
    { word: "one", file: "one.png", turkish: "bir" },
    { word: "two", file: "two.png", turkish: "iki" },
    { word: "three", file: "three.png", turkish: "üç" },
    { word: "four", file: "four.png", turkish: "dört" },
    { word: "five", file: "five.png", turkish: "beş" },
    { word: "six", file: "six.png", turkish: "altı" },
    { word: "seven", file: "seven.png", turkish: "yedi" },
    { word: "eight", file: "eight.png", turkish: "sekiz" },
    { word: "nine", file: "nine.png", turkish: "dokuz" },
    { word: "ten", file: "ten.png", turkish: "on" },
  ];
  ...
  useEffect(() => {
    const words: GameCard[] = selectedCards.map((item, idx) => ({
      id: `word-${idx}`,
      word: item.word,
      imageUrl: `/images/preschool/vocab/0.1-numbers/${item.file}`,
  ...
  const shareGame = () => {
    const text = `I just scored ${formatTime(elapsedTime)} on Matchlings Numbers! Can you beat my time? 🔢`;
    if (navigator.share) {
      navigator.share({
        title: "Matchlings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Matchlings Numbers! Can you match all the numbers faster than my ${formatTime(elapsedTime)}? 🏆`;
    if (navigator.share) {
      navigator.share({
