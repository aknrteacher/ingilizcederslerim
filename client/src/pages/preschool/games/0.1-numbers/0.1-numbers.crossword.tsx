...
// Vocabulary from 0.1 (Numbers)
const vocabulary = [
  { word: "ONE", clue: "Bir", file: "one.png" },
  { word: "TWO", clue: "İki", file: "two.png" },
  { word: "THREE", clue: "Üç", file: "three.png" },
  { word: "FOUR", clue: "Dört", file: "four.png" },
  { word: "FIVE", clue: "Beş", file: "five.png" },
  { word: "SIX", clue: "Altı", file: "six.png" },
  { word: "SEVEN", clue: "Yedi", file: "seven.png" },
  { word: "EIGHT", clue: "Sekiz", file: "eight.png" },
  { word: "NINE", clue: "Dokuz", file: "nine.png" },
  { word: "TEN", clue: "On", file: "ten.png" },
];
...
export default function NumbersCrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/preschool/vocab/0.1-numbers/${vocab.file}` : null;
  }).filter(Boolean) as string[];

  const shareGame = () => {
    const text = `I just solved the Numbers Word Cross! Can you beat it? 🔢`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Numbers",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Numbers Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
  ...
  const generateGrid = () => {
    ...
    // Shuffle and pick words (max 10 for numbers)
