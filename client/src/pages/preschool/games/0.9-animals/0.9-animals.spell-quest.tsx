...
export default function AnimalsSpellQuestGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points on Spell Quest Animals! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Spell Quest - Animals", text, url: window.location.href });
    } else {
      alert(text);
    }
  };
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Spell Quest Animals! I scored ${score} points - can you do better? 🏆`;
    if (navigator.share) {
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <p className="complete-subtitle">You spelled all the animals!</p>
