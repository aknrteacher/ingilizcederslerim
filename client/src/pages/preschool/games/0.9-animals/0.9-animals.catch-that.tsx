...
const animalMap: Record<string, { bg: string; text: string; border: string }> = {
  "ANIMALS": { bg: "bg-orange-500", text: "text-white", border: "border-orange-600" },
  "CAT": { bg: "bg-gray-500", text: "text-white", border: "border-gray-600" },
  "DOG": { bg: "bg-amber-500", text: "text-white", border: "border-amber-600" },
  "BEAR": { bg: "bg-brown-600", text: "text-white", border: "border-brown-800" },
  "FROG": { bg: "bg-green-500", text: "text-white", border: "border-green-600" },
  "ELEPHANT": { bg: "bg-gray-600", text: "text-white", border: "border-gray-700" },
  "WHALE": { bg: "bg-blue-500", text: "text-white", border: "border-blue-600" },
  "FLAMINGO": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "RABBIT": { bg: "bg-white", text: "text-gray-800", border: "border-gray-300" },
  "MONKEY": { bg: "bg-yellow-600", text: "text-white", border: "border-yellow-800" },
  "SHEEP": { bg: "bg-white", text: "text-gray-800", border: "border-gray-200" },
  "HORSE": { bg: "bg-amber-600", text: "text-white", border: "border-amber-800" },
  "COW": { bg: "bg-black", text: "text-white", border: "border-gray-800" },
  "LION": { bg: "bg-yellow-400", text: "text-gray-800", border: "border-yellow-500" },
  "MOUSE": { bg: "bg-gray-300", text: "text-white", border: "border-gray-500" },
  "CHICKEN": { bg: "bg-yellow-300", text: "text-gray-800", border: "border-yellow-500" },
};
...
export default function AnimalsCatchGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Catch That Animals! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Catch That Animals - English Learning Game", text, url: window.location.href });
    } else {
      navigator.clipboard.writeText(text + " " + window.location.href);
    }
  };
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-gradient-to-b from-amber-50 to-green-100/30 rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            <div
              ...
              {gameStarted && (
                ...
                const wordStyle = animalMap[word.word];
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {gameWon 
                    ? `You caught all ${totalWords} animals!` 
