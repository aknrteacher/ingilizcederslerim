...
export default function OurBodySpellQuestGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points on Spell Quest Our Body! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Spell Quest - Our Body", text, url: window.location.href });
    } else {
      alert(text);
    }
  };
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Spell Quest Our Body! I scored ${score} points - can you do better? 🏆`;
    if (navigator.share) {
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <p className="complete-subtitle">You spelled all the body parts!</p>
