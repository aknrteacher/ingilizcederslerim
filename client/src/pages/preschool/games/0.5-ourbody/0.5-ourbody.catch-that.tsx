...
const bodyPartMap: Record<string, { bg: string; text: string; border: string }> = {
  "BODY": { bg: "bg-blue-500", text: "text-white", border: "border-blue-600" },
  "HEAD": { bg: "bg-green-500", text: "text-white", border: "border-green-600" },
  "ARMS": { bg: "bg-rose-500", text: "text-white", border: "border-rose-600" },
  "LEGS": { bg: "bg-indigo-500", text: "text-white", border: "border-indigo-600" },
  "FEET": { bg: "bg-emerald-500", text: "text-white", border: "border-emerald-600" },
  "TOE": { bg: "bg-teal-500", text: "text-white", border: "border-teal-600" },
  "HANDS": { bg: "bg-cyan-500", text: "text-white", border: "border-cyan-600" },
  "FINGER": { bg: "bg-sky-500", text: "text-white", border: "border-sky-600" },
  "HAIR": { bg: "bg-amber-500", text: "text-white", border: "border-amber-600" },
  "FACE": { bg: "bg-fuchsia-500", text: "text-white", border: "border-fuchsia-600" },
  "EARS": { bg: "bg-yellow-400", text: "text-gray-800", border: "border-yellow-500" },
  "NOSE": { bg: "bg-orange-500", text: "text-white", border: "border-orange-600" },
  "EYES": { bg: "bg-purple-500", text: "text-white", border: "border-purple-600" },
  "MOUTH": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "TEETH": { bg: "bg-slate-500", text: "text-white", border: "border-slate-600" },
};
...
export default function OurBodyCatchGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Catch That Our Body! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Catch That Our Body - English Learning Game", text, url: window.location.href });
    } else {
      navigator.clipboard.writeText(text + " " + window.location.href);
    }
  };
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-gradient-to-b from-amber-50 to-green-100/30 rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            <div
              ...
              {gameStarted && (
                ...
                const wordStyle = bodyPartMap[word.word];
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {gameWon 
                    ? `You caught all ${totalWords} body parts!` 
