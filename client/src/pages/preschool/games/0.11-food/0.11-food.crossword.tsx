...
export default function FoodCrosswordGame() {
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Food Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
      ...
      <div className="crossword-game-wrapper" id="crossword-game-wrapper">
        <div className="crossword-game-container">
          <>
            ...
            <PreschoolGameHeader 
              gameName="Word Cross"
              description="Pre-School & 1st Grade - Theme: Food"
