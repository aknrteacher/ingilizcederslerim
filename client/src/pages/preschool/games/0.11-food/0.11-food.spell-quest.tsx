...
export default function FoodSpellQuestGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points on Spell Quest Food! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Spell Quest - Food", text, url: window.location.href });
    } else {
      alert(text);
    }
  };
  ...
  const challengeFriend = () => {
    const text = `Challenge me on Spell Quest Food! I scored ${score} points - can you do better? 🏆`;
    if (navigator.share) {
          ...
          {gameComplete && (
            ...
            >
              <div className="complete-content">
                ...
                <p className="complete-subtitle">You spelled all the foods!</p>
