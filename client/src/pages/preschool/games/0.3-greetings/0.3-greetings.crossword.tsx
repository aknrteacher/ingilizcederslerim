...
// Vocabulary from 0.3 (Greetings) - convert multi-word to single word for crossword
const vocabulary = [
  ...
  { word: "GOODAFTERNOON", clue: "İyi öğleden sonra", file: "good afternoon.png" },
  { word: "GOODNIGHT", clue: "İyi geceler", file: "good night.png" },
  { word: "THANKYOU", clue: "Teşekkür ederim", file: "thank you.png" },
  { word: "HOWAREYOU", clue: "Nasılsın?", file: "how are you.png" },
  { word: "IAMFINE", clue: "İyiyim", file: "I am fine.png" },
  { word: "PLEASE", clue: "Lütfen", file: "please.png" },
  { word: "SORRY", clue: "Özür dilerim", file: "sorry.png" },
  { word: "YES", clue: "Evet", file: "yes.png" },
  { word: "NO", clue: "Hayır", file: "no.png" },
];
...
export default function GreetingsCrosswordGame() {
  ...
  const collageImages = placedWords.map(pw => {
      ...
      return vocab?.file ? `/images/preschool/vocab/0.3-greetings/${vocab.file}` : null;
  }).filter(Boolean) as string[];

  const shareGame = () => {
    const text = `I just solved the Greetings Word Cross! Can you beat it? 👋`;
    if (navigator.share) {
      navigator.share({
        title: "Word Cross - Greetings",
        text: text,
  ...
  const challengeFriend = () => {
    const text = `I challenge you to solve this Greetings Word Cross puzzle! 🏆`;
    if (navigator.share) {
      navigator.share({
  ...
  return (
    <Layout>
      <div className="crossword-game-wrapper" id="crossword-game-wrapper">
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[65%_35%] gap-4 relative flex-1 min-h-0 overflow-hidden" id="crossword-game">
              ...
              <div id="crossword-grid-area" className="flex flex-col gap-3 relative z-10 min-h-0">
                ...
                <AnimatePresence>
                  {selectedWordId && (
                    <motion.div 
                      ...
                      exit={{ opacity: 0, y: -20 }}
                      className="bg-yellow-100/95 backdrop-blur-md border-l-4 border-yellow-500 p-3 rounded-r-xl shadow-lg z-30 flex-shrink-0"
                    >
                ...
                {/* Crossword Grid */}
                <div className="bg-white/60 backdrop-blur-md p-2 sm:p-4 rounded-2xl shadow-xl border-2 border-amber-300 flex justify-center items-center relative flex-1 min-h-0 overflow-auto">
                  <div 
              ...
              <div id="crossword-clues-area" className="min-h-0 overflow-hidden flex flex-col relative z-10">
                <div className="bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border-2 border-amber-300 flex-1 min-h-0 flex flex-col">
            ...
            {/* Footer Actions */}
            <div className="preschool-game-footer relative z-10">
