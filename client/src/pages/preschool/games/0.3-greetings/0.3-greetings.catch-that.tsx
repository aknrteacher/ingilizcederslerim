...
const vocabulary = [
  ...
  { word: "THANKYOU", turkish: "Teşekkür ederim", file: "thank you.png" },
  { word: "HOWAREYOU", turkish: "Nasılsın?", file: "how are you.png" },
  { word: "IAMFINE", turkish: "İyiyim", file: "I am fine.png" },
  { word: "PLEASE", turkish: "Lütfen", file: "please.png" },
  { word: "SORRY", turkish: "Özür dilerim", file: "sorry.png" },
  { word: "YES", turkish: "Evet", file: "yes.png" },
  { word: "NO", turkish: "Hayır", file: "no.png" },
];

const greetingMap: Record<string, { bg: string; text: string; border: string }> = {
  "HELLO": { bg: "bg-blue-500", text: "text-white", border: "border-blue-600" },
  "HI": { bg: "bg-green-500", text: "text-white", border: "border-green-600" },
  "GOODBYE": { bg: "bg-purple-500", text: "text-white", border: "border-purple-600" },
  "GOODMORNING": { bg: "bg-yellow-400", text: "text-gray-800", border: "border-yellow-500" },
  "GOODAFTERNOON": { bg: "bg-orange-500", text: "text-white", border: "border-orange-600" },
  "GOODNIGHT": { bg: "bg-indigo-500", text: "text-white", border: "border-indigo-600" },
  "THANKYOU": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "HOWAREYOU": { bg: "bg-cyan-500", text: "text-white", border: "border-cyan-600" },
  "IAMFINE": { bg: "bg-emerald-500", text: "text-white", border: "border-emerald-600" },
  "PLEASE": { bg: "bg-rose-500", text: "text-white", border: "border-rose-600" },
  "SORRY": { bg: "bg-gray-500", text: "text-white", border: "border-gray-600" },
  "YES": { bg: "bg-lime-500", text: "text-gray-800", border: "border-lime-600" },
  "NO": { bg: "bg-red-500", text: "text-white", border: "border-red-600" },
};
...
export default function GreetingsCatchGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Catch That Greetings! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Catch That Greetings - English Learning Game", text, url: window.location.href });
    } else {
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-gradient-to-b from-amber-50 to-green-100/30 rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            >
              <div className={'w-32 h-32 sm:w-48 sm:h-48 ' + (isFullscreen ? 'w-96 h-96 ' : '') + 'rounded-2xl bg-amber-50 flex items-center justify-center overflow-hidden mb-3 mx-auto'}>
                <img 
                  src={'/images/preschool/vocab/0.3-greetings/' + currentWord.file} 
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {gameWon 
                    ? `You caught all ${totalWords} greetings!` 
