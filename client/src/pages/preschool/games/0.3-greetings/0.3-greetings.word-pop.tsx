...
const greetingBalloonMap: Record<string, { color: string, textColor: string }> = {
  "HELLO": { color: "from-blue-400 to-blue-600", textColor: "text-white" },
  "HI": { color: "from-green-400 to-green-600", textColor: "text-white" },
  "GOODBYE": { color: "from-purple-400 to-purple-600", textColor: "text-white" },
  "GOODMORNING": { color: "from-yellow-300 to-yellow-500", textColor: "text-gray-800" },
  "GOODAFTERNOON": { color: "from-orange-400 to-orange-600", textColor: "text-white" },
  "GOODNIGHT": { color: "from-indigo-400 to-indigo-600", textColor: "text-white" },
  "THANKYOU": { color: "from-pink-400 to-pink-500", textColor: "text-white" },
  "HOWAREYOU": { color: "from-cyan-400 to-cyan-600", textColor: "text-white" },
  "IAMFINE": { color: "from-emerald-400 to-emerald-600", textColor: "text-white" },
  "PLEASE": { color: "from-rose-400 to-rose-600", textColor: "text-white" },
  "SORRY": { color: "from-gray-400 to-gray-600", textColor: "text-white" },
  "YES": { color: "from-lime-400 to-lime-600", textColor: "text-gray-800" },
  "NO": { color: "from-red-400 to-red-600", textColor: "text-white" },
};
...
function GreetingBalloonShape({ word, shape }: { word: string, shape: string }) {
  const colorStyle = greetingBalloonMap[word] || { color: "from-gray-400 to-gray-600", textColor: "text-white" };
...
export default function GreetingsWordPopGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Word Pop Greetings! Can you beat my score? 🎈`;
    if (navigator.share) {
      navigator.share({ title: "Word Pop Greetings - English Learning Game", text, url: window.location.href });
    } else {
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {gameWon 
                    ? `You completed all ${totalWords} greetings!` 
