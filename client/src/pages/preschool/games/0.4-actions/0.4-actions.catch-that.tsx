...
const actionMap: Record<string, { bg: string; text: string; border: string }> = {
  ...
  "SIT": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "SLEEP": { bg: "bg-indigo-500", text: "text-white", border: "border-indigo-600" },
  "READ": { bg: "bg-emerald-500", text: "text-white", border: "border-emerald-600" },
  "DRAW": { bg: "bg-amber-500", text: "text-white", border: "border-amber-600" },
  "SING": { bg: "bg-rose-500", text: "text-white", border: "border-rose-600" },
...
const formatWordForDisplay = (word: string): string => word;

const formatWordForSpeech = (word: string): string => word.toLowerCase();
