...
const aroundUsMap: Record<string, { bg: string; text: string; border: string }> = {
  "ANIMALS": { bg: "bg-orange-500", text: "text-white", border: "border-orange-600" },
  "CITY": { bg: "bg-purple-500", text: "text-white", border: "border-purple-600" },
  "CLOUDS": { bg: "bg-white", text: "text-gray-700", border: "border-gray-300" },
  "FLOWER": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "HOUSE": { bg: "bg-amber-600", text: "text-white", border: "border-amber-800" },
  "GRASS": { bg: "bg-lime-500", text: "text-white", border: "border-lime-600" },
  "MOON": { bg: "bg-gray-300", text: "text-gray-800", border: "border-gray-400" },
  "PEOPLE": { bg: "bg-pink-500", text: "text-white", border: "border-pink-600" },
  "RAIN": { bg: "bg-slate-500", text: "text-white", border: "border-slate-600" },
  "SKY": { bg: "bg-sky-400", text: "text-white", border: "border-sky-500" },
  "STAR": { bg: "bg-indigo-500", text: "text-white", border: "border-indigo-600" },
  "SUN": { bg: "bg-yellow-400", text: "text-gray-800", border: "border-yellow-500" },
  "TREE": { bg: "bg-green-600", text: "text-white", border: "border-green-700" },
  "WATER": { bg: "bg-cyan-500", text: "text-white", border: "border-cyan-600" },
  "WORLD": { bg: "bg-blue-500", text: "text-white", border: "border-blue-600" },
};
...
export default function AroundUsCatchGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Catch That Around Us! Can you beat my score? 👋`;
    if (navigator.share) {
      navigator.share({ title: "Catch That Around Us - English Learning Game", text, url: window.location.href });
    } else {
      navigator.clipboard.writeText(text + " " + window.location.href);
    }
  };
          ...
          <div className={'flex-1 flex flex-col lg:flex-row items-stretch gap-4 lg:gap-8 bg-gradient-to-b from-amber-50 to-green-100/30 rounded-xl p-3 sm:p-6 ' + (isFullscreen ? 'min-h-[600px]' : 'min-h-[500px]')}>
            ...
            <div
              ...
              {gameStarted && (
                ...
                const wordStyle = aroundUsMap[word.word];
