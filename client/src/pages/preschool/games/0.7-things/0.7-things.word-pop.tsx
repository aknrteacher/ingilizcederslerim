...
function ThingsBalloonShape({ word, shape }: { word: string, shape: string }) {
  const colorStyle = thingsBalloonMap[word] || { color: "from-gray-400 to-gray-600", textColor: "text-white" };
...
export default function ThingsWordPopGame() {
                ...
                return (
                  ...
                  >
                    <div className="relative balloon-wiggle" style={{ animationDelay: `${index * 0.2}s` }}>
                      <ThingsBalloonShape word={balloon.word} shape={balloon.shape} />
