...
const peopleBalloonMap: Record<string, { color: string, textColor: string }> = {
  "TEACHER": { color: "from-blue-400 to-blue-600", textColor: "text-white" },
  "FRIEND": { color: "from-green-400 to-green-600", textColor: "text-white" },
  "BOY": { color: "from-purple-400 to-purple-600", textColor: "text-white" },
  "GIRL": { color: "from-pink-400 to-pink-600", textColor: "text-white" },
  "MOM": { color: "from-yellow-300 to-yellow-500", textColor: "text-gray-800" },
  "DAD": { color: "from-orange-400 to-orange-600", textColor: "text-white" },
  "SISTER": { color: "from-cyan-400 to-cyan-600", textColor: "text-white" },
...
function PeopleBalloonShape({ word, shape }: { word: string, shape: string }) {
  const colorStyle = peopleBalloonMap[word] || { color: "from-gray-400 to-gray-600", textColor: "text-white" };
...
export default function PeopleWordPopGame() {
  ...
  const shareGame = () => {
    const text = `I scored ${score} points in Word Pop People! Can you beat my score? 🎈`;
    if (navigator.share) {
      navigator.share({ title: "Word Pop People - English Learning Game", text, url: window.location.href });
    } else {
                ...
                return (
                  ...
                  >
                    <div className="relative balloon-wiggle" style={{ animationDelay: `${index * 0.2}s` }}>
                      <PeopleBalloonShape word={balloon.word} shape={balloon.shape} />
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {gameWon 
                    ? `You completed all ${totalWords} people!` 
