...
export default function AlphabetVocabulary() {
  ...
  const imageFiles = [
    { word: "A", file: "a.png", turkish: "A" },
    { word: "B", file: "b.png", turkish: "B" },
    { word: "C", file: "c.png", turkish: "C" },
    { word: "D", file: "d.png", turkish: "D" },
    { word: "E", file: "e.png", turkish: "E" },
    { word: "F", file: "f.png", turkish: "F" },
    { word: "G", file: "g.png", turkish: "G" },
    { word: "H", file: "h.png", turkish: "H" },
    { word: "I", file: "i.png", turkish: "I" },
    { word: "J", file: "j.png", turkish: "J" },
    { word: "K", file: "k.png", turkish: "K" },
    { word: "L", file: "l.png", turkish: "L" },
    { word: "M", file: "m.png", turkish: "M" },
    { word: "N", file: "n.png", turkish: "N" },
    { word: "O", file: "o.png", turkish: "O" },
    { word: "P", file: "p.png", turkish: "P" },
    { word: "Q", file: "q.png", turkish: "Q" },
    { word: "R", file: "r.png", turkish: "R" },
    { word: "S", file: "s.png", turkish: "S" },
    { word: "T", file: "t.png", turkish: "T" },
    { word: "U", file: "u.png", turkish: "U" },
    { word: "V", file: "v.png", turkish: "V" },
    { word: "W", file: "w.png", turkish: "W" },
    { word: "X", file: "x.png", turkish: "X" },
    { word: "Y", file: "y.png", turkish: "Y" },
    { word: "Z", file: "z.png", turkish: "Z" },
  ];
  ...
  useEffect(() => {
    const vocabData = imageFiles.map((item) => ({
      word: item.word,
      imageUrl: `/images/preschool/vocab/0.0-alphabet/${item.file}`,
    ...
    if (option === 'copy') {
      ...
      try {
        await navigator.share({
          title: 'Ä°ngilizce Derslerim - Alphabet',
          text: `Check out this alphabet vocabulary lesson on Ä°ngilizce Derslerim!`,
          url: currentUrl,
        });
        setShowShareDrawer(false);
      } catch (err) {
