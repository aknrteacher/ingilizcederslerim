...
// Import topic button half (300x100px) - using placeholder for now
import topic4_6 from "@/assets/3.1game.png"; // TODO: Replace with 4.6game.png when available
...
export default function PrimarySchoolGrade4Unit6GamesMenu() {
  ...
  const topic = {
    ...
    image: topic4_6, // TODO: Replace with actual 4.6game.png
  };
