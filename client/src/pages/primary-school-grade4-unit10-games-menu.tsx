...
export default function PrimarySchoolGrade4Unit10GamesMenu() {
  const gameTypes = [
    { id: "matching", name: "Matchlings", icon: "🎮", gradient: "yellow-orange" as const, pathSuffix: "4.10-matching-game", image: gameTypeMatchlings },
  ...
  const gameCombinations = gameTypes.map((gameType) => ({
    ...
    path: `/primary-school/grade-4/unit-10/${gameType.pathSuffix}`,
