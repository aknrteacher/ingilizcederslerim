...
import topic3_10 from "@/assets/3.9game.png";
...
export default function PrimarySchoolGrade3Unit10GamesMenu() {
  const gameTypes = [
    {
      id: "matching",
      name: "Matchlings",
  ...
  const gameCombinations = gameTypes.map((gameType) => ({
    ...
    path: `/primary-school/grade-3/unit-10/${gameType.pathSuffix}`,
