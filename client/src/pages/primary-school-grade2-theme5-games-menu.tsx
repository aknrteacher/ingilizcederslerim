...
export default function PrimarySchoolGrade2Theme5GamesMenu() {
  ...
  const topic = {
    value: "2.5",
    label: "Evler, Konutlar, Mahalleler (Homes, Houses, Neighbourhoods)",
    image: topic2_5,
  };
  ...
  const gameCombinations = gameTypes.map((gameType) => ({
    ...
    path: `/primary-school/grade-2/theme-5/${gameType.pathSuffix}`,
    ...
    <Layout>
      <div className="oyunlar-container">
        <div className="oyunlar-header">
          <div>
            <h1 className="oyunlar-title">2. Sınıf - Tema 5: Evler, Konutlar, Mahalleler</h1>
            <p className="oyunlar-subtitle">Evler, konutlar ve mahallelerle ilgili kelimeleri öğren ve oyunlarla pekiştir</p>
          </div>
        </div>
