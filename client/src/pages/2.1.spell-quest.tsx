...
export default function SpellQuestGame() {
  ...
  if (!currentWord && !gameComplete) {
    return (
      <Layout>
        <div className="spell-quest-wrapper">
  ...
  return (
    <Layout>
      <div className="spell-quest-wrapper" id="spell-quest-game">
        <div className="spell-quest-container">
          ...
          <div className="game-header">
            ...
            <div className="fullscreen-btn-wrapper">
              <FullscreenButton containerId="spell-quest-game" />
            </div>
          </div>
            ...
            >
              <div className="complete-content">
                ...
                <div className="complete-buttons">
                  ...
                  <Button variant="outline" onClick={() => setLocation("/oyunlar")}>
                    Back to Games
                  </Button>
                </div>
              </div>
          ...
          <div className="game-footer">
            ...
            <Button variant="ghost" className="back-link" onClick={() => setLocation("/oyunlar")}>
              ← Back
            </Button>
          </div>
        </div>
