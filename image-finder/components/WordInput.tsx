...
const WordInput: React.FC<WordInputProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="w-full max-w-6xl space-y-10 animate-fade-in">
      {/* 1. Preview Styles */}
      <div className="bg-surface p-8 rounded-2xl border border-slate-600/50">
            ...
            <div key={id} className="flex flex-col items-center gap-2">
              ...
              {editingPromptFor === id && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/95" onClick={cancelPromptEdit}>
                  <div
                    className="w-full max-w-lg bg-surface p-6 rounded-2xl border border-slate-600 shadow-xl space-y-4"
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full p-4 bg-slate-800 border border-slate-600 rounded-xl text-slate-100 text-sm min-h-[120px] focus:ring-2 focus:ring-accent placeholder:text-slate-500"
